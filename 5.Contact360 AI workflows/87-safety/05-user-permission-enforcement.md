---
id: 5.8.1.2
title: User permission checks (respect RBAC on all tool calls)
...
# User permission checks (respect RBAC on all tool calls)

> Stub generated from [`index.json`](../index.json) (`5.8.1.2`) on 2026-04-19.
