---
id: 5.8.3.1
title: User-level rate limiting (max queries/minute, max concurrent sessions)
...
# User-level rate limiting (max queries/minute, max concurrent sessions)

> Stub generated from [`index.json`](../index.json) (`5.8.3.1`) on 2026-04-19.
