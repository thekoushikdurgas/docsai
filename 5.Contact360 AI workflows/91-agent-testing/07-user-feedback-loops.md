---
id: 5.12.2.1
title: "User feedback loops (did agent's recommendation help? Rate it)"
...
# User feedback loops (did agent's recommendation help? Rate it)

> Stub generated from [`index.json`](../index.json) (`5.12.2.1`) on 2026-04-19.
