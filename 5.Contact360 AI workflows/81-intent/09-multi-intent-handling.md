---
id: 5.2.2.3
title: Multi-intent detection (user asks for multiple things at once)
...
# Multi-intent detection (user asks for multiple things at once)

> Stub generated from [`index.json`](../index.json) (`5.2.2.3`) on 2026-04-19.
