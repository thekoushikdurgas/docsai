---
id: 5.13.2.1
title: REST API for agent queries (POST /api/ai/query)
...
# REST API for agent queries (POST /api/ai/query)

> Stub generated from [`index.json`](../index.json) (`5.13.2.1`) on 2026-04-19.
