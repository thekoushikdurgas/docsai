---
id: 5.1.1.5
title: Memory update node (store in Redis session, long-term DB, vector)
...
# Memory update node (store in Redis session, long-term DB, vector)

> Stub generated from [`index.json`](../index.json) (`5.1.1.5`) on 2026-04-19.
