---
id: 5.1.0.3
title: Checkpointing strategy (Redis vs PostgreSQL, session persistence)
...
# Checkpointing strategy (Redis vs PostgreSQL, session persistence)

> Stub generated from [`index.json`](../index.json) (`5.1.0.3`) on 2026-04-19.
