---
id: 5.5.0.1
title: Short-term memory (Redis session, 2-hour TTL)
...
# Short-term memory (Redis session, 2-hour TTL)

> Stub generated from [`index.json`](../index.json) (`5.5.0.1`) on 2026-04-19.
