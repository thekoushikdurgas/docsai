...
- **Status:** ✅ Completed
## Focus
Performance Lens — surface/data micro-slice (patch 4)

## Flowchart

```mermaid
flowchart LR
    patchNode["10.8.4 — Soil"] --> workNode["Performance Lens — surface/data micro-slice (patch 4)"]
...
## Tasks
### Surface
- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: ✅ completed: tbd for exit gate) | patch `10.8.4` band `4` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
...
- ✅ Completed: 📌 Planned: **[emailcampaign]** — Diff and document schema for operations like ConnectraClient, LAMBDA_AI_API_URL, LAMBDA_CONNECTRA_API_URL; align with roadmap | area: `backend-api` | files: `docs/backend/apis/*.md`, `contact360.io/api/app/graphql/schema.py` | reason: Keep GraphQL/REST contracts aligned for era 10.4 patch 10.8.4


### Service

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: ✅ completed: 📌 planned: **[emailcampaign]** — service slice:…) | patch `10.8.4` band `4` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md


### Ops

- ✅ Completed: 📌 Planned: **[platform]** — Record smoke evidence, rollback, and alerts (patch band 4: surface/data) | area: `ops` | files: `docs/commands/`, `.github/workflows/` | reason: Smoke, rollback, and observability for patch 10.8.4
