...
- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[architecture]** — product **graphql** remains …) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
### Service

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: ✅ completed: 📌 planned: **[emailcampaign]** — service slice:…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: ✅ completed: 📌 planned: **[jobs]** — harden primary worker/g…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[architecture]** — **go/gin satellites** in sco…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
### Surface

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[emailcampaign]** — refine duplicate task (was:…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md

### Data

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[emailcampaign]** — refine duplicate task (was:…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[architecture]** — **postgresql-first** per `do…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[architecture]** — **redis exit**: campaign (as…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
### Ops

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[emailcampaign]** — refine duplicate task (was:…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md

- 📌 Planned: **[emailcampaign]** — refine duplicate task (was: 📌 planned: **[architecture]** — **observability**: correlate…) | patch `10.6.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/emailcampaign-codebase-analysis.md
