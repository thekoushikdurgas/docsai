...
```mermaid
flowchart LR
    patchNode["4.3.8 — Archive"] --> workNode["Old versions"]
...
- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: idempotency + merge rules documented…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md
- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: connectra error codes for conflict v…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Service

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: replay same batch → stable row count…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md
- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: no duplicate identities for same lin…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Surface

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: dashboard or admin: conflict summary…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Data

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: pg + es document fields for merge ou…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md
- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: drift detection hooks (deep link **3…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Ops

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: kpi: **sync conflict auto-resolution…) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md
- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: runbook: forced manual merge.) | patch `4.3.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md
