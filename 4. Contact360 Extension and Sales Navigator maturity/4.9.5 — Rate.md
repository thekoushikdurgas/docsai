...
```mermaid
flowchart LR
    patchNode["4.9.5 — Rate"] --> workNode["Client cap"]
...
- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: document max retries, idempotency ex…) | patch `4.9.5` band `5` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Service

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: server-side 429 hints honored; circu…) | patch `4.9.5` band `5` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Surface

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: user messaging: “temporarily unavail…) | patch `4.9.5` band `5` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Data

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: no corruption of partial batch check…) | patch `4.9.5` band `5` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md

### Ops

- 📌 Planned: **[salesnavigator]** — refine duplicate task (was: ✅ completed: 📌 planned: slo: extension error budget; burn ra…) | patch `4.9.5` band `5` | reason: specialize this file vs sibling patches; see docs/codebases/salesnavigator-codebase-analysis.md
