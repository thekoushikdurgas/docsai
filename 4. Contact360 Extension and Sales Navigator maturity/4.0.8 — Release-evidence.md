...
- ✅ Completed: 📌 Planned: **[logsapi]** — Confirm logs/metrics/traces and update endpoint era matrix if APIs changed | area: `observability` | files: `docs/backend/endpoints/` | reason: Late patch band: ops evidence and endpoint matrix
