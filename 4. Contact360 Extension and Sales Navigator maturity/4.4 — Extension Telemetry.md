...
- 📌 Planned: Freeze **`4.x`** extension/SN event types — **Service task slices** in `4.4.P` patch files (scope from former `logsapi-extension-salesnav-task-pack.md`), [`extension-telemetry.md`](extension-telemetry.md).
