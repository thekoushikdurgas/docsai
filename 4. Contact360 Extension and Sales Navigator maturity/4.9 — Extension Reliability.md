...
- 📌 Planned: Document max retries, idempotency expectations — **Service task slices** in `4.9.P` patches (ex-`connectra-extension-sn-task-pack.md`, `jobs-extension-sn-task-pack.md`).
