...
- 📌 Planned: Connectra error codes for conflict vs validation — **Service task slices** in `4.3.P` patch files (scope from former `connectra-extension-sn-task-pack.md`).
