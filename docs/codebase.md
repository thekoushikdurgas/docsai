...
| `contact360.io/email/` | Mailbox/email web surface | Next.js 16, React 19, TypeScript |
...
| `extension/contact360/` | Extension logic/transport layer | JavaScript (auth/session, Lambda client, profile merge); popup/content/manifest shell tracked separately |
...
5. Move idempotency and abuse guard state to Redis for multi-replica horizontal scaling.
...
- Data coupling: local Django persistence plus Appointment360 GraphQL, Redis cache, and S3 index artifacts.
