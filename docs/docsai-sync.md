...
6. For reliability updates touching admin operations, keep migration status of `_analyze_jobs`, `_generate_json_jobs`, and `_upload_jobs` explicit (in-memory vs Redis/DB).
