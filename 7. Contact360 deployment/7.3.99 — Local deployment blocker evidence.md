...
- ~~`EC2/job.server`~~ **Removed (2026-04):** job orchestration moved to `contact360.io/api` + `EC2/email.server` / `EC2/sync.server`.
...
- [x] ~~Ship `.env.example` for `job.server`~~ — N/A (`EC2/job.server` removed).
