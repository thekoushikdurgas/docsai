...
## Tasks
### Contract
- 📌 Planned: **[appointment360]** — refine duplicate task (was: 📌 planned: define tenant-safe request/response and failure s…) | patch `7.10.1` band `1` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: **[appointment360]** — refine duplicate task (was: 📌 planned: per-tenant api key contract: replace single globa…) | patch `7.10.1` band `1` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: Tie role model to `docs/7. Contact360 deployment/rbac-authz.md` and gateway role semantics.
- 📌 Planned: Versioning policy: `/v1` remains stable; legacy routes officially deprecated.

### Service
- 📌 Planned: **[appointment360]** — refine duplicate task (was: 📌 planned: ensure handler-level authz mirrors gateway role c…) | patch `7.10.1` band `1` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: **[appointment360]** — refine duplicate task (was: 📌 planned: emit audit log events (to `logs.api`) on: chat cr…) | patch `7.10.1` band `1` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: Implement and validate service behavior for era `7.x` event sources and query expectations.
- 📌 Planned: Ensure worker drain logic without message loss.


### Surface

- 📌 Planned: **[admin]** — Verify UX for route `/` and bindings (patch 7.10.1 band 1) | area: `frontend-page` | files: `contact360/dashboard/app/page.tsx` | reason: Dashboard/extension surface for era 7 must match gateway contracts


### Data

- 📌 Planned: **[appointment360]** — refine duplicate task (was: 📌 planned: **[appointment360]** — update postgresql/es/s3 li…) | patch `7.10.1` band `1` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md


### Ops

- 📌 Planned: **[platform]** — Record smoke evidence, rollback, and alerts (patch band 1: charter/P0) | area: `ops` | files: `docs/commands/`, `.github/workflows/` | reason: Smoke, rollback, and observability for patch 7.10.1
