"""
Local company data ingestion module.

This module handles ingesting company data from local CSV files.
"""
...
class LocalCompanyIngester(LocalFileIngester):
    """Ingester for company data from local CSV files."""
        ...
        for data in data_list:
            try:
                ...
                company_metadata = {
                    ...
                    "linkedin_sales_url": data.get('company_linkedin_sales_url') or '_',
...
def ingest_companies_from_local(
    path: str,
    batch_size: int = DEFAULT_BATCH_SIZE,
    max_threads: int = DEFAULT_MAX_THREADS
) -> None:
    """
    Ingest company data from a local CSV file.
    ...
    """
    ingester = LocalCompanyIngester(path, batch_size=batch_size, max_threads=max_threads)
    with ingester:
        ingester.ingest()
...
if __name__ == "__main__":
    ...
    ingest_companies_from_local('data/3519363_1M.csv')
