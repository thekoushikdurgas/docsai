...
## Tasks
### Ops
- ✅ Completed: 📌 Planned: **app**: enforce v9.0 ops outcomes for tenant config overlays; ship smoke scripts for key UI-to-API journeys in `contact360.io/app` while advancing entitlement enforcement.
- ✅ Completed: 📌 Planned: **sync**: enforce v9.0 ops outcomes for tenant config overlays; add drift-alert playbooks and resync controls in `contact360.io/sync` while advancing entitlement enforcement.
- ✅ Completed: 📌 Planned: **mailvetter**: enforce v9.0 ops outcomes for tenant config overlays; define verification SLA monitors and escalation points in `backend(dev)/mailvetter` while advancing tenant config overlays.
- ✅ Completed: 📌 Planned: **emailapigo**: enforce v9.0 ops outcomes for tenant config overlays; instrument Go service KPIs and on-call diagnostics in `lambda/emailapigo` while advancing tenant config overlays.


### Contract

- ✅ Completed: 📌 Planned: **[appointment360]** — Diff and document schema for operations like ConnectraClient, LAMBDA_AI_API_URL, LAMBDA_CONNECTRA_API_URL; align with roadmap | area: `backend-api` | files: `docs/backend/apis/*.md`, `contact360.io/api/app/graphql/schema.py` | reason: Keep GraphQL/REST contracts aligned for era 9.8 patch 9.0.8


### Service

- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: **[appointment360]** — service slice…) | patch `9.0.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md


### Surface

- ✅ Completed: 📌 Planned: **[app]** — Verify UX for route `/email` and bindings (patch 9.0.8 band 8) | area: `frontend-page` | files: `contact360.io/app/...` | reason: Dashboard/extension surface for era 9 must match gateway contracts


### Data

- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: **[appointment360]** — update postgr…) | patch `9.0.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
