...
- Doc files in this tree: `kebab-case.md` or domain-prefixed names; align with routes under `contact360.io/app` / `root` / `admin`.

## Structure contract

- Long-form references should cite **code paths** and link to [`../pages/`](../pages/) for machine-readable page specs when routes change.

## File index

- This README is the hub; deep dives are organized by surface (dashboard, marketing, email app) in sections above. Page inventory: [`../pages/README.md`](../pages/README.md).
