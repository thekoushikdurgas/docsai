---
title: "Drafts"
page_id: mailhub_draft_page
source_json: mailhub_draft_page.json
...
- **surface:** Mailhub
- **era_tags:** 2.x, 11.x
- **flow_id:** mailhub-draft
- **_id:** mailhub_draft_page-001

## Metadata

- **route:** /draft
- **file_path:** contact360.io/email/src/app/draft/page.tsx
- **purpose:** Draft messages composer/shell for Mailhub.
- **s3_key:** data/pages/mailhub_draft_page.json
- **status:** published
...
**Composite layout:** [L] > [Q:Folders] + [Q:DraftList] + (btn:Compose) — {REST}
