...
| --- | --- | --- | --- |
| `GetMe` | [query_get_me_graphql.md](../../backend/endpoints/query_get_me_graphql.md) | QUERY | 1.x |
| `ListAPIKeys` | [query_list_api_keys_graphql.md](../../backend/endpoints/query_list_api_keys_graphql.md) | QUERY | 8.x |
| `ListSessions` | [query_list_sessions_graphql.md](../../backend/endpoints/query_list_sessions_graphql.md) | QUERY | 1.x |
| `ListTeamMembers` | [query_list_team_members_graphql.md](../../backend/endpoints/query_list_team_members_graphql.md) | QUERY | 0.x |
| `Get2FAStatus` | [query_get_2fa_status_graphql.md](../../backend/endpoints/query_get_2fa_status_graphql.md) | QUERY | 9.x |
| `CreateAPIKey` | [mutation_create_api_key_graphql.md](../../backend/endpoints/mutation_create_api_key_graphql.md) | MUTATION | 8.x |
| `DeleteAPIKey` | [mutation_delete_api_key_graphql.md](../../backend/endpoints/mutation_delete_api_key_graphql.md) | MUTATION | 8.x |
| `RevokeSession` | [mutation_revoke_session_graphql.md](../../backend/endpoints/mutation_revoke_session_graphql.md) | MUTATION | 1.x |
| `InviteTeamMember` | *unresolved — add to endpoint index* | — | — |
| `UpdateTeamMemberRole` | *unresolved — add to endpoint index* | — | — |
| `RemoveTeamMember` | *unresolved — add to endpoint index* | — | — |
| `Setup2FA` | [mutation_setup_2fa_graphql.md](../../backend/endpoints/mutation_setup_2fa_graphql.md) | MUTATION | 9.x |
| `Verify2FA` | [mutation_verify_2fa_graphql.md](../../backend/endpoints/mutation_verify_2fa_graphql.md) | MUTATION | 9.x |
| `Disable2FA` | [mutation_disable_2fa_graphql.md](../../backend/endpoints/mutation_disable_2fa_graphql.md) | MUTATION | 9.x |
| `UpdateProfile` | [mutation_update_profile_graphql.md](../../backend/endpoints/mutation_update_profile_graphql.md) | MUTATION | 9.x |
| `UploadAvatar` | [mutation_upload_avatar_graphql.md](../../backend/endpoints/mutation_upload_avatar_graphql.md) | MUTATION | 3.x |

**Unresolved operations** (not found in `index.md` / `endpoints_index.md`): 
`graphql/InviteTeamMember`, `graphql/UpdateTeamMemberRole`, `graphql/RemoveTeamMember`
