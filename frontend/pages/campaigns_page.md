...
**Composite layout:** [L:Dashboard] > [H:Header] + [Q:PlannedPlaceholder] (10.x Era)
] (10.x Era)
...
**Typical outbound:** Sidebar peers; [campaign_builder_page.md](campaign_builder_page.md) (edit); [analytics_page.md](analytics_page.md) (stats).

**Cross-host:** Campaign execution and tracking synced with **email** (Mailhub) for reliable message delivery.
**Backend:** Appointment360 GraphQL gateway; campaign management and background scheduling services.
