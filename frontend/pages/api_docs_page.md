...
**Composite layout:** [C] > [H:API] + [T:Endpoints] + [Q:CodeExample] + [C:Footer]
...
**Typical inbound:** [landing_page.md](landing_page.md) footer, SEO, [docs_page.md](docs_page.md).

**Typical outbound:** [landing_page.md](landing_page.md), sign in / register.

**Cross-host:** Hand-off to `app` (authentication) for API key management.
**Backend:** Public developer portal; no first-party GraphQL host in `root`.
