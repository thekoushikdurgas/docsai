...
| --- | --- | --- | --- |
| `CompanyQuery` | [get_company_graphql.md](../../backend/endpoints/get_company_graphql.md) | QUERY | 3.x |
| `CompanyFilters` | [get_company_filters_graphql.md](../../backend/endpoints/get_company_filters_graphql.md) | QUERY | 3.x |
| `GenerateCompanySummary` | [mutation_generate_company_summary_graphql.md](../../backend/endpoints/mutation_generate_company_summary_graphql.md) | MUTATION | 3.x |
