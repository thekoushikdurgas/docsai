---
title: "Spam"
page_id: mailhub_spam_page
source_json: mailhub_spam_page.json
...
- **surface:** Mailhub
- **era_tags:** 2.x, 11.x
- **flow_id:** mailhub-spam
- **_id:** mailhub_spam_page-001

## Metadata

- **route:** /spam
- **file_path:** contact360.io/email/src/app/spam/page.tsx
- **purpose:** Spam folder: EmailList with folder=spam.
- **s3_key:** data/pages/mailhub_spam_page.json
- **status:** published
