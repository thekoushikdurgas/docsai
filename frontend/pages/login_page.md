...
**Composite layout:** [L:AuthPage] > [C:AuthCard] > [H:Title] + [F:Form] + [B:SocialAuth] -> {useAuth}
...
| --- | --- | --- | --- |
| `Login` | [mutation_login_graphql.md](../../backend/endpoints/mutation_login_graphql.md) | MUTATION | 6.x |
