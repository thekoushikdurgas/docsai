...
**Composite layout:** [L:Dashboard] > [H:Header] + [C:ExportForm] + [T:ExportHistory] -> {useJobs}
...
**Typical inbound:** `Sidebar` (Admin); [contacts_page.md](contacts_page.md) / [companies_page.md](companies_page.md) (Bulk Action -> View Progress).

**Typical outbound:** Sidebar peers; [files_page.md](files_page.md) (Download history); [jobs_page.md](jobs_page.md) (Task status).

**Cross-host:** Large export artifacts are stored in S3 and referenced by the **email** (Mailhub) codebase for attachment processing.
**Backend:** Appointment360 GraphQL gateway; asynchronous job workers for multi-TB dataset extraction.
...
| `CancelExport` | [mutation_cancel_export_graphql.md](../../backend/endpoints/mutation_cancel_export_graphql.md) | MUTATION | 3.x |
| `S3ListFiles` | [query_list_s3_files_graphql.md](../../backend/endpoints/query_list_s3_files_graphql.md) | QUERY | 3.x |
