---
title: "Inbox"
page_id: mailhub_inbox_page
source_json: mailhub_inbox_page.json
...
- **surface:** Mailhub
- **era_tags:** 2.x, 11.x
- **flow_id:** mailhub-inbox
- **_id:** mailhub_inbox_page-001

## Metadata

- **route:** /inbox
- **file_path:** contact360.io/email/src/app/inbox/page.tsx
- **purpose:** IMAP inbox: EmailList with folder=inbox; primary mail reading surface.
- **s3_key:** data/pages/mailhub_inbox_page.json
- **status:** published
- **authentication:** Required (IMAP session)
...
| id | label | steps |
| --- | --- | --- |
| folder-load | Load folder messages | ['EmailList receives folder prop', 'Backend email API lists messages'] |
...
**Composite layout:** [L] > [Q:Folders] + [Q:InboxList] + (btn:Refresh) — {REST}
