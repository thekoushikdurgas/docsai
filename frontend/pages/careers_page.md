...
**Composite layout:** [C] > [H:Hero] + [K:Culture] + [T:OpenRoles] + (btn:apply-role) + [F:Footer]
...
**Typical outbound:** Sign in / Get started → **app** [login_page.md](login_page.md) / [register_page.md](register_page.md); primary CTA → `/register`.
