...
export default function BottomStartDropdownMenuDemo() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center overflow-hidden bg-background p-8">
      <DemoMenu side="bottom" align="start" />
    </div>
  )
}
...
Install NPM dependencies:
```bash
@carbon/icons-react, @radix-ui/react-dropdown-menu
```
