...
```mermaid
flowchart LR
    patchNode["1.8.2 — Quota"] --> workNode["Limits"]
...
## Tasks
### Contract
- ✅ Completed: Define quota behavior when pack is expiring:
- ✅ Completed: how remaining is computed in grace vs expired.

### Service
- ✅ Completed: Ensure quota/remaining is derived from correct columns:
- ✅ Completed: credits total/consumed plus reset/grace rules.

### Surface
- ✅ Completed: Usage UI and remaining bars reflect expiry state without contradictions.

### Data
- ✅ Completed: `credits` ledger invariants hold across state transitions.

### Ops
- ✅ Completed: Verify no “silent loss of access”:
- ✅ Completed: state changes reflect immediately after boundary checks.
