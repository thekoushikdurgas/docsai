...
## Tasks
### Contract
- ✅ Completed: Define whitelist of internal/health requests that bypass certain checks.

### Service
- ✅ Completed: Implement whitelist safely (avoid bypassing billing/admin-critical endpoints).

### Surface
- ✅ Completed: No user-facing changes besides improved stability.

### Data
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: n/a.) | patch `1.7.6` band `6` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md

### Ops
- ✅ Completed: Verify health/introspection still work under high load.
