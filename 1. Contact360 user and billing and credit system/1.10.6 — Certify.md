...
```mermaid
flowchart LR
    patchNode["1.10.6 — Certify"] --> workNode["Sign-offs"]
...
## Tasks
### Contract
- ✅ Completed: Certification checklist includes:
- ✅ Completed: “billing critical paths have defined health and rollback”.

### Service
- ✅ Completed: Run final integration suite:
- ✅ Completed: bulk pipeline smoke,
- ✅ Completed: proof upload → admin approve → credits update,
- ✅ Completed: usage query correctness.

### Surface
- ✅ Completed: Production build passes.

### Data
- ✅ Completed: Backup/restore evidence exists for gateway DB (users + credits).

### Ops
- ✅ Completed: Collect sign-offs from:
- ✅ Completed: Finance/Ops (reconciliation),
- ✅ Completed: Security (fraud/abuse rules),
- ✅ Completed: Platform (metrics/CI).
