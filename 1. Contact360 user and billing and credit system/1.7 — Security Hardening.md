...
- 📌 Planned: Document **rate-limit** error in GraphQL extensions; client retry guidance.

### Service

- 📌 Planned: Redis or in-memory store consistent across Lambda/EC2 deploy target.  
- 📌 Planned: Whitelist internal health / introspection policy.

### Surface

- 📌 Planned: App: backoff on 429; user-friendly message.

### Data

- 📌 Planned: Optional persistence of block events to logs.api.

### Ops

- 📌 Planned: Tune limits per environment; alert on abuse spike vs legit traffic drop.
