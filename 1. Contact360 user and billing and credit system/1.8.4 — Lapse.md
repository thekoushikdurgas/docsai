...
```mermaid
flowchart LR
    patchNode["1.8.4 — Lapse"] --> workNode["State machine"]
...
## Tasks
### Contract
- ✅ Completed: Freeze lapse state machine semantics:
- ✅ Completed: transitions and idempotency rules.

### Service
- ✅ Completed: Ensure lapse transition is idempotent:
- ✅ Completed: repeated detection does not produce inconsistent credits status or double audits.

### Surface
- ✅ Completed: Lapse UX record and banner updates.

### Data
- ✅ Completed: Store lapse state transitions for later audit:
- ✅ Completed: use consistent status enums and lineage to `subscriptions`.

### Ops
- ✅ Completed: Playbook:
- ✅ Completed: users stuck in lapse/grace have a defined reconciliation procedure.
