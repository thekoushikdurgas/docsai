...
```mermaid
flowchart LR
    patchNode["1.6.3 — Override"] --> workNode["Emergency adjust"]
...
## Tasks
### Contract
- ✅ Completed: Define emergency adjustment semantics:
- ✅ Completed: allowed mutation types (`creditUser`, `adjustCredits`) and required reason fields.

### Service
- ✅ Completed: Ensure adjustments are safe:
- ✅ Completed: write actor/reason/before-after atomically,
- ✅ Completed: restrict negative/positive adjust behaviors to authorized use-cases.

### Surface
- ✅ Completed: Admin provides clear confirmation steps (disable “submit” until reason exists if required).

### Data
- ✅ Completed: `credits` ledger and any related adjustment records reconcile with subsequent `usage(feature)` reads.

### Ops
- ✅ Completed: Test “emergency adjust” path:
- ✅ Completed: wrong reason still blocked (if policy),
- ✅ Completed: correct adjustment shows updated remaining credits.
