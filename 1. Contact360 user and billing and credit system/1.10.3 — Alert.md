...
## Tasks
### Contract
- ✅ Completed: Define alert thresholds:
- ✅ Completed: credit mismatch,
- ✅ Completed: payment failures spikes,
- ✅ Completed: divergence between charged_rows and ledger/usage.

### Service
- ✅ Completed: Ensure alerts are driven by reliable signals:
- ✅ Completed: logs.api billing event categories are queryable and indexed.

### Surface
- ✅ Completed: Not applicable (ops alerts).

### Data
- ✅ Completed: Record event schema versions and retention windows.

### Ops
- ✅ Completed: Validate alert routing to runbook owners with correct severity.
