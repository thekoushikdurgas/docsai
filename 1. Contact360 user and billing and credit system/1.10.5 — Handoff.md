...
```mermaid
flowchart LR
    patchNode["1.10.5 — Handoff"] --> workNode["2.x dependency list"]
...
## Tasks
### Contract
- ✅ Completed: Produce a dependency list for `2.x` kickoff:
- ✅ Completed: what 1.x exports/ledger guarantees are assumed.

### Service
- ✅ Completed: Ensure no hidden constraints break `2.x` assumptions:
- ✅ Completed: schema freeze notes for billing/credits.

### Surface
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: not applicable.) | patch `1.10.5` band `5` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md

### Data
- ✅ Completed: Include reconciliation/diff baselines for 2.x.

### Ops
- ✅ Completed: Handoff doc created and reviewed by platform/security owners.
