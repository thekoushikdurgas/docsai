...
```mermaid
flowchart LR
    patchNode["1.7.1 — Filter"] --> workNode["Path rules"]
...
## Tasks
### Contract
- ✅ Completed: Define path rules:
- ✅ Completed: apply rate limit only to `/graphql` and potentially admin/internal endpoints as required.

### Service
- ✅ Completed: Ensure rate-limit middleware doesn’t block health probes or introspection endpoints.

### Surface
- ✅ Completed: Ensure internal UI calls (dashboard loads) are not affected unexpectedly.

### Data
- ✅ Completed: N/A (middleware-layer change).

### Ops
- ✅ Completed: Smoke: health endpoints still respond under burst.
