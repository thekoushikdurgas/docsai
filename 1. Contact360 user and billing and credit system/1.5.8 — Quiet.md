...
## Tasks
### Contract
- ✅ Completed: Define additional suppression:
- ✅ Completed: don’t show low-credit cue while the user is already on the billing page (optional MVP rule).

### Service
- ✅ Completed: Ensure suppression doesn’t interfere with critical auth failures or billing state correctness.

### Surface
- ✅ Completed: Suppression rules evaluated with routing awareness.

### Data
- ✅ Completed: No new DB requirements for MVP; keep suppression ephemeral.

### Ops
- ✅ Completed: Regression: verify billing page still shows payment and proof flows even when alerts suppressed.
