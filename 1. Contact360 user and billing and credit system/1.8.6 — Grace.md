...
## Tasks
### Contract
- ✅ Completed: Document grace window policy:
- ✅ Completed: duration,
- ✅ Completed: allowed actions,
- ✅ Completed: exact semantics for `GRACE_PERIOD` error responses.

### Service
- ✅ Completed: Grace logic is time-bounded and consistent across replicas:
- ✅ Completed: avoid off-by-one errors at boundaries.

### Surface
- ✅ Completed: UX shows “grace” state and remaining time; renew CTA remains active.

### Data
- ✅ Completed: Store or derive grace window boundaries deterministically from persisted state.

### Ops
- ✅ Completed: Boundary tests:
- ✅ Completed: grace start/end show correct errors and UI overlays.
