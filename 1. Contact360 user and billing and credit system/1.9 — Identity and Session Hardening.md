...
- 📌 Planned: `twoFactor` module in schema — align with `docs/backend/apis` stubs.

### Service

- 📌 Planned: Secure secret storage for TOTP seed; constant-time verify.  
- 📌 Planned: Recovery codes policy (optional).

### Surface

- 📌 Planned: Enrollment UX; QR display; backup codes download.

### Data

- 📌 Planned: `two_factor_secrets` or column on users — encrypted at rest.

### Ops

- 📌 Planned: Lockout / support reset runbook.
