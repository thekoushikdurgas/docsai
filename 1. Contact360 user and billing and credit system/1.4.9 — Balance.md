...
## Tasks
### Contract
- ✅ Completed: Freeze 1.4 public contract surface:
- ✅ Completed: no breaking changes to `UsageQuery` response keys for 1.5/1.6.

### Service
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: integration gates:) | patch `1.4.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- ✅ Completed: usage query + credits badge + usage UI consistency.

### Surface
- ✅ Completed: Final UI smoke:
- ✅ Completed: cards/table render correctly with loading + error states.

### Data
- ✅ Completed: Migrations/seed data for credits/plans remain valid and consistent.

### Ops
- ✅ Completed: Sign-off for handoff to `1.5` notification cues (ensuring low-credit triggers still use correct usage values).
