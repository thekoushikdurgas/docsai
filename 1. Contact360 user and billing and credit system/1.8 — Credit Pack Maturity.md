...
- 📌 Planned: GraphQL errors: `PACK_EXPIRED`, `GRACE_PERIOD` — document semantics.

### Service

- 📌 Planned: Cron or lazy check on **usage** / **billing** read; consistent with **deduction**.  
- 📌 Planned: Idempotent lapse transition.

### Surface

- 📌 Planned: Renewal CTA; clear copy on **frozen** features.

### Data

- 📌 Planned: `subscriptions` / `credits.reset_at` or equivalent; migration evidence.

### Ops

- 📌 Planned: Reconciliation: users stuck in grace — playbook.
