...
## Tasks
### Contract
- ✅ Completed: Define positive credit adjustment contract:
- ✅ Completed: update credits total/consumed per adjustment policy,
- ✅ Completed: ensure idempotency if admin double-submits.

### Service
- ✅ Completed: Implement/validate positive credit mutation:
- ✅ Completed: writes audit event and updates ledger in a single transaction.

### Surface
- ✅ Completed: Admin credit adjust modal shows “before/after” preview (if available) and confirms completion.

### Data
- ✅ Completed: Credits ledger updates reconcile with usage query outputs.

### Ops
- ✅ Completed: Smoke test:
- ✅ Completed: grant for a user results in increased remaining credits immediately.
