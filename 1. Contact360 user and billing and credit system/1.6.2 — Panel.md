...
```mermaid
flowchart LR
    patchNode["1.6.2 — Panel"] --> workNode["Admin UI shell"]
...
## Tasks
### Contract
- ✅ Completed: Define UI contract for the admin shell:
- ✅ Completed: data tables require stable IDs, pagination, and row-level actions.

### Service
- ✅ Completed: Admin client calls map to gateway operations (appointments module + billing/admin module operations).

### Surface
- ✅ Completed: Admin templates include:
- ✅ Completed: user management table,
- ✅ Completed: credit adjust modal inputs (`credit-amount`, `credit-reason`),
- ✅ Completed: payment submissions review table.

### Data
- ✅ Completed: Table data aligns with admin query response shape and logs evidence.

### Ops
- ✅ Completed: UI smoke:
- ✅ Completed: admin navigates between tabs and sees consistent data refresh.
