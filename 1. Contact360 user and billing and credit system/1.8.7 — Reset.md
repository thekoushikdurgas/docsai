...
```mermaid
flowchart LR
    patchNode["1.8.7 — Reset"] --> workNode["Balance"]
...
## Tasks
### Contract
- ✅ Completed: Define balance reset semantics after renewal/grace end:
- ✅ Completed: what happens to consumed/used counters.

### Service
- ✅ Completed: Reset credits ledger state atomically:
- ✅ Completed: update totals and consumed counters consistently.

### Surface
- ✅ Completed: Expiry banners disappear; remaining credits bar refreshes to correct value.

### Data
- ✅ Completed: Ensure ledger update reconciles with usage query results immediately after reset.

### Ops
- ✅ Completed: Test: user can spend credits after reset with consistent ledger deltas.
