...
```mermaid
flowchart LR
    patchNode["1.10.2 — Observe"] --> workNode["Metrics"]
...
## Tasks
### Contract
- ✅ Completed: Define the metrics to observe:
- ✅ Completed: request/error/duration aggregate metrics from middleware,
- ✅ Completed: reconciliation divergence metrics.

### Service
- ✅ Completed: Ensure tracing ids propagate:
- ✅ Completed: request_id and trace_id are attached end-to-end.

### Surface
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: not applicable.) | patch `1.10.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md

### Data
- ✅ Completed: Metrics are backed by logs.api where needed for later admin investigation.

### Ops
- ✅ Completed: Confirm metrics dashboards:
- ✅ Completed: billing dashboards KPIs reflect reality for credits/payments.
