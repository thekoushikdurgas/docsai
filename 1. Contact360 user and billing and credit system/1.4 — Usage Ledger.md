...
- 📌 Planned: Stable **`UsageQuery`** fields; feature enum alignment with deduction code.

### Service

- 📌 Planned: No N+1 on usage page; consider DataLoaders.

### Surface

- 📌 Planned: `app/(dashboard)/usage/page.tsx` pattern; hooks `useUsage`, `usageService`.

### Data

- 📌 Planned: Ledger rows consistent with **`deduct_credit`**; reconciliation job or report optional.

### Ops

- 📌 Planned: Cache invalidation if usage cached client-side.
