...
## Tasks
### Contract
- ✅ Completed: Synthetic probe definition:
- ✅ Completed: `login → usage read` and optional billing smoke (in a staging/test env).

### Service
- ✅ Completed: Probe uses stable GraphQL operations:
- ✅ Completed: `AuthMutation.login` then `UsageQuery.usage`.

### Surface
- ✅ Completed: Not applicable (ops-only).

### Data
- ✅ Completed: Probe stores trace/request id and expected response invariants.

### Ops
- ✅ Completed: Automate probe in CI:
- ✅ Completed: fail CI if health invariants break.
