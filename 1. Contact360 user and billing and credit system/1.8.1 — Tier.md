...
```mermaid
flowchart LR
    patchNode["1.8.1 — Tier"] --> workNode["Plan rules"]
...
## Tasks
### Contract
- ✅ Completed: Define plan-tier rule mapping on expiry:
- ✅ Completed: which features freeze,
- ✅ Completed: which features remain during grace.

### Service
- ✅ Completed: Apply plan rules consistently:
- ✅ Completed: align `plans.limits` JSON with feature-key gating.

### Surface
- ✅ Completed: Locked feature overlay appears only where policy says (plan-specific).

### Data
- ✅ Completed: Ensure feature enum naming matches between:
- ✅ Completed: deduction buckets,
- ✅ Completed: plans limit keys,
- ✅ Completed: gating logic.

### Ops
- ✅ Completed: Test matrix across plan tiers (free/pro/enterprise if applicable).
