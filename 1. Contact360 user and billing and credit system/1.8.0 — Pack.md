...
```mermaid
flowchart LR
    patchNode["1.8.0 — Pack"] --> workNode["Charter"]
...
## Tasks
### Contract
- ✅ Completed: Define entitlement errors and semantics:
- ✅ Completed: `PACK_EXPIRED`,
- ✅ Completed: `GRACE_PERIOD`.
- ✅ Completed: Contract states what API/UI actions are allowed in each state (expired vs grace vs active).

### Service
- ✅ Completed: Implement entitlement engine with time dimension:
- ✅ Completed: derive state from `subscriptions.billing_period_end` and/or `credits.reset_at`.

### Surface
- ✅ Completed: Add expiry UX:
- ✅ Completed: expiry banner,
- ✅ Completed: countdown/date display,
- ✅ Completed: renew button CTA.

### Data
- ✅ Completed: Validate state lineage:
- ✅ Completed: `subscriptions.status` transitions,
- ✅ Completed: `credits.reset_at` updates.

### Ops
- ✅ Completed: Policy evidence:
- ✅ Completed: time simulation for activation → expiry → grace boundaries and reconciliation notes.
