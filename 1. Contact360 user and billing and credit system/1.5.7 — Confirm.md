...
## Tasks
### Contract
- ✅ Completed: Define user acknowledgement:
- ✅ Completed: dismiss/snooze low-credit cue (MVP) or mark as read (if using notifications persistence later).

### Service
- ✅ Completed: If persistent later: use `markNotificationAsRead` / `markNotificationsAsRead` mutations.

### Surface
- ✅ Completed: Dismiss interaction confirmed by UI state change.

### Data
- ✅ Completed: Session-scoped suppression key updated on ack.

### Ops
- ✅ Completed: Test: ack suppresses cue until next meaningful credit change.
