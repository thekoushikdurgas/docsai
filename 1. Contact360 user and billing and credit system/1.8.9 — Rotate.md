...
## Tasks
### Contract
- ✅ Completed: Define policy refresh semantics:
- ✅ Completed: state machine and thresholds remain consistent through the patch.

### Service
- ✅ Completed: Ensure no runtime regressions after policy refresh:
- ✅ Completed: state derivation stays deterministic.

### Surface
- ✅ Completed: UX remains stable (no flicker or inconsistent overlays during refresh).

### Data
- ✅ Completed: No schema changes required; ensure existing migrations remain valid.

### Ops
- ✅ Completed: Freeze:
- ✅ Completed: sign-off before `1.9` identity/session hardening.
