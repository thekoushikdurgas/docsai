...
- 📌 Planned: `usage`, `analytics`, `admin` GraphQL operations documented.  
- 📌 Planned: Rate limit: config keys + error shape for throttled clients.

### Service

- 📌 Planned: Usage **aggregation** or query path performant for MVP scale.  
- 📌 Planned: Admin mutations: **creditUser**, **adjustCredits** — audit-wrapped.

### Surface

- 📌 Planned: [`docs/governance.md`](../governance.md) pointers: `usage/page.tsx`, `CreditBudgetAlerts`, admin clients.

### Data

- 📌 Planned: logs.api **S3 CSV** events for billing/auth if admin views query logs.

### Ops

- 📌 Planned: Dashboard health for rate-limit metrics optional.
