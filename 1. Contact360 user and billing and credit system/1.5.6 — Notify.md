...
```mermaid
flowchart LR
    patchNode["1.5.6 — Notify"] --> workNode["Component polish"]
...
## Tasks
### Contract
- ✅ Completed: Polish the alert component and toast patterns:
- ✅ Completed: avoid inconsistent copy,
- ✅ Completed: avoid mismatched icons/colors across alert/CTA.

### Service
- ✅ Completed: Ensure alert states are derived from the same server payload shape.

### Surface
- ✅ Completed: Component uses consistent UI primitives (Alert/Badge/Toast patterns already used in the app).

### Data
- ✅ Completed: Optional: align “acknowledged” behavior with later notification persistence.

### Ops
- ✅ Completed: Visual regression smoke for 3 threshold bands.
