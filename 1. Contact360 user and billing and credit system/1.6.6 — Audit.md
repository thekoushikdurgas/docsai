...
```mermaid
flowchart LR
    patchNode["1.6.6 — Audit"] --> workNode["log pipeline"]
...
## Tasks
### Contract
- ✅ Completed: Define audit event requirements for credit adjustments and payment decisions:
- ✅ Completed: include actor, reason, submission_id when relevant.

### Service
- ✅ Completed: Ensure audit pipeline emits logs events on adjustment completion.

### Surface
- ✅ Completed: Provide admin UX hooks to view “why” for changes (at least via trace/log identifiers).

### Data
- ✅ Completed: Ensure logs/audit evidence references stable IDs (user_uuid, submission_id).

### Ops
- ✅ Completed: Evidence test:
- ✅ Completed: adjustment produces one audit log entry and is queryable.
