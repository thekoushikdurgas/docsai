---
id: 2.6.1.2
title: Extension caching strategy (local storage, service worker)
...
# Extension caching strategy (local storage, service worker)

> Stub generated from [`index.json`](../index.json) (`2.6.1.2`) on 2026-04-19.
