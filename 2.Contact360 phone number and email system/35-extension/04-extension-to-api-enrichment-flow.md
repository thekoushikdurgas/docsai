---
id: 2.6.1.1
title: Browser → extension → API → enrichment → cache locally
phase: 2.Contact360 phone number and email system
owner: TBD
last_reviewed: 2026-04-19
status: stub
flow_refs: ["flow2", "flow5"]
schema_refs: ["EnrichmentJob.json"]
---

# Browser → extension → API → enrichment → cache locally

> Stub generated from [`index.json`](../index.json) (`2.6.1.1`) on 2026-04-19.
