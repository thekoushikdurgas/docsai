---
id: 2.8.2.2
title: Data export & portability (user data download in JSON/CSV)
...
# Data export & portability (user data download in JSON/CSV)

> Stub generated from [`index.json`](../index.json) (`2.8.2.2`) on 2026-04-19.
