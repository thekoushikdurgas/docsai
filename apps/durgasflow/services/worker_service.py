...
class WorkerService:
    ...
    def queue_execution(cls, execution_id: str, workflow_id: str) -> Optional[str]:
        ...
        try:
            ...
            logger.debug(f"Queued execution {execution_id} with task ID {task_id}")
            return task_id
    ...
    def queue_scheduled_workflow(cls, workflow_id: str) -> Optional[str]:
        ...
        try:
            ...
            logger.debug(f"Queued scheduled workflow {workflow_id}")
            return task_id
    ...
    def setup_schedule(cls, workflow_id: str, cron: str) -> None:
        ...
        try:
            ...
            logger.debug(f"Created schedule for workflow {workflow_id}: {cron}")
    ...
    def remove_schedule(cls, workflow_id: str) -> None:
        ...
        try:
            ...
            if deleted:
                logger.debug(f"Removed schedule for workflow {workflow_id}")
