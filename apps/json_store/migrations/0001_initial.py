    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.SlugField(help_text='URL-safe identifier, auto-generated from label', max_length=200, unique=True)),
                ('label', models.CharField(help_text='Human-readable name', max_length=300)),
