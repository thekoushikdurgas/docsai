...
urlpatterns = [
    path("", lambda r: __import__("django.shortcuts", fromlist=["redirect"]).redirect("admin_ops:users"), name="index"),
    ...
    path("billing/payments/<str:payment_id>/approve/", views.approve_payment_view, name="approve_payment"),
    path("billing/payments/<str:payment_id>/decline/", views.decline_payment_view, name="decline_payment"),
    path("billing/plans/new/", views.billing_plan_create_view, name="billing_plan_create"),
    path(
    ...
    path("billing/plans/<str:tier>/delete/", views.billing_plan_delete_view, name="billing_plan_delete"),
    path("billing/plans/<str:tier>/edit/", views.billing_plan_edit_view, name="billing_plan_edit"),
    path("billing/plans/", views.billing_plans_view, name="billing_plans"),
    path("billing/addons/new/", views.billing_addon_create_view, name="billing_addon_create"),
    path(
