"""Durgasman Models — Postman-compatible collection and environment storage.

Replaces the postman_app models.  Tables are owned by the 'durgasman' app label.
"""
...
class DurgasmanCollection(models.Model):
    ...
    class Meta:
        ...
        verbose_name = "Durgasman Collection"
        verbose_name_plural = "Durgasman Collections"
...
class DurgasmanEnvironment(models.Model):
    ...
    class Meta:
        ordering = ["-uploaded_at"]
        verbose_name = "Durgasman Environment"
        verbose_name_plural = "Durgasman Environments"
