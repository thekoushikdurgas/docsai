"""Durgasman request runner — proxies HTTP requests from the admin backend.

Uses httpx (already available in the admin virtualenv).
Ported from postman_app.services.request_runner.
"""
...
def run_request(
    ...
    try:
        ...
        logger.exception("durgasman request_runner unexpected error")
