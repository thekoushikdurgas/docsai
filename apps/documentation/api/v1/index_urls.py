...
urlpatterns = [
    ...
    path(
        "pages/validate/", index_views.index_pages_validate, name="index_pages_validate"
    ),
    path(
        "endpoints/validate/",
        index_views.index_endpoints_validate,
        name="index_endpoints_validate",
    ),
    path(
        "relationships/validate/",
        index_views.index_relationships_validate,
        name="index_relationships_validate",
    ),
    path(
        "postman/validate/",
        index_views.index_postman_validate,
