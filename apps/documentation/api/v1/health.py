...
def health(request: HttpRequest) -> JsonResponse:
    ...
    try:
        ...
        return JsonResponse({"success": True, "data": health_status})
...
def health_database(request: HttpRequest) -> JsonResponse:
    ...
    try:
        ...
        return JsonResponse({"success": True, "data": db_health})
    except Exception as e:
        return JsonResponse({"success": False, "error": str(e)}, status=500)
...
def health_cache(request: HttpRequest) -> JsonResponse:
    ...
    try:
        ...
        return JsonResponse({"success": True, "data": cache_health})
    except Exception as e:
        return JsonResponse({"success": False, "error": str(e)}, status=500)
...
def health_storage(request: HttpRequest) -> JsonResponse:
    ...
    try:
        ...
        return JsonResponse({"success": True, "data": storage_health})
    except Exception as e:
        return JsonResponse({"success": False, "error": str(e)}, status=500)
