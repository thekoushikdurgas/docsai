...
urlpatterns = [
    ...
    path("docs/endpoint-stats-by-user-type/", views.endpoint_stats_by_user_type, name="endpoint_stats_by_user_type"),
    ...
    path("dashboard/relationships/", views.dashboard_relationships, name="dashboard_relationships"),
