...
from apps.documentation.utils.api_v1_helpers import should_expand_full, to_page_list_item
...
def pages_detail_components(request: HttpRequest, page_id: str) -> JsonResponse:
    try:
        ...
        components = sections.get("components", []) if isinstance(sections, dict) else []
