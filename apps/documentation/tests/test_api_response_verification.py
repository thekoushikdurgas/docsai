...
class APIResponseFormatVerificationTestCase(TestCase):
    ...
    def test_error_response_format(self):
        ...
        response = error_response(
            message="Error occurred", errors=["Error 1", "Error 2"]
        )
        response_dict = response.to_dict()
    ...
    def test_pagination_format(self):
        ...
        response = paginated_response(
            data=[{"id": 1}, {"id": 2}], total=100, page=2, page_size=50
        )
        response_dict = response.to_dict()
    ...
    def test_metadata_format(self):
        ...
        response = success_response(
            data={"key": "value"}, meta={"custom": "metadata", "count": 5}
        )
        response_dict = response.to_dict()
...
class ResponseHelpersVerificationTestCase(TestCase):
    ...
    def test_error_response_helper(self):
        ...
        response = error_response(
            message="Error message", errors=["Error 1"], status_code=400
        )
    ...
    def test_paginated_response_helper(self):
        ...
        response = paginated_response(data=[{"id": 1}], total=50, page=1, page_size=10)
