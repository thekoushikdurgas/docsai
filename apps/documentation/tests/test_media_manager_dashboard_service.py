...
class MediaManagerDashboardServiceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        with patch(
            "apps.documentation.services.documentation_dashboard_service.get_pages_service",
            return_value=self.mock_pages_service,
        ), patch(
            "apps.documentation.services.documentation_dashboard_service.get_endpoints_service",
            return_value=self.mock_endpoints_service,
        ), patch(
            "apps.documentation.services.documentation_dashboard_service.get_relationships_service",
            return_value=self.mock_relationships_service,
        ), patch(
            "apps.documentation.services.documentation_dashboard_service.get_postman_service",
            return_value=self.mock_postman_service,
        ):
    ...
    def test_get_dashboard_overview_success(self):
        ...
        self.mock_endpoints_service.get_method_statistics.return_value = {
            "methods": [{"method": "GET", "count": 40}, {"method": "POST", "count": 20}]
        }
    ...
    def test_get_resource_detail_endpoints(self):
        ...
        self.mock_endpoints_service.get_endpoint.assert_called_once_with(
            "test-endpoint"
        )
    ...
    def test_get_health_status(self):
        ...
        with patch(
            "apps.documentation.services.documentation_dashboard_service.get_comprehensive_health_status",
    ...
    def test_get_dashboard_overview_error_handling(self):
        ...
        self.mock_pages_service.get_pages_statistics.side_effect = Exception(
            "Service error"
        )
