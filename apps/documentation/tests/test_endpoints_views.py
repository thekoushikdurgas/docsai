...
class EndpointDetailViewTestCase(BaseAPITestCase):
    ...
    def setUp(self):
        ...
        self.detail_url = reverse(
            "documentation:endpoint_detail", args=[self.endpoint_id]
        )
    ...
    def test_endpoint_detail_view_success(
        self, mock_relationships_service, mock_endpoints_service
    ):
    ...
    def test_endpoint_detail_view_not_found(self, mock_endpoints_service):
        ...
        mock_endpoints_service.get_endpoint.side_effect = NotFoundError(
            "Endpoint not found"
        )
...
class EndpointCreateAPITestCase(BaseAPITestCase):
    ...
    def test_endpoint_create_api_invalid_json(self):
        ...
        response = self.client.post(
            self.create_api_url, data="invalid json", content_type="application/json"
        )
...
class EndpointUpdateAPITestCase(BaseAPITestCase):
    ...
    def setUp(self):
        ...
        self.update_api_url = reverse(
            "documentation:api_endpoint_update", args=[self.endpoint_id]
        )
    ...
    def test_endpoint_update_api_not_found(self, mock_endpoints_service):
        ...
        mock_endpoints_service.update_endpoint.side_effect = NotFoundError(
            "Endpoint not found"
        )
...
class EndpointDeleteAPITestCase(BaseAPITestCase):
    ...
    def setUp(self):
        ...
        self.delete_api_url = reverse(
            "documentation:api_endpoint_delete", args=[self.endpoint_id]
        )
    ...
    def test_endpoint_delete_api_not_found(self, mock_endpoints_service):
        ...
        mock_endpoints_service.delete_endpoint.side_effect = NotFoundError(
            "Endpoint not found"
        )
