...
@require_super_admin
def media_manager_relationship_detail(
    ...
    try:
        ...
        # Get related data
        access_control = relationships_service.get_relationship_access_control(
            relationship_id
        )
        data_flow = relationships_service.get_relationship_data_flow(relationship_id)
        performance = relationships_service.get_relationship_performance(
            relationship_id
        )
        dependencies = relationships_service.get_relationship_dependencies(
            relationship_id
        )
        ...
        logger.error(
            f"Error loading relationship detail {relationship_id}: {e}", exc_info=True
        )
...
def media_manager_relationships_format(request: HttpRequest) -> HttpResponse:
    ...
    try:
        from apps.documentation.api.v1.relationships_views import (
            relationships_format as api_relationships_format,
        )
...
def media_manager_relationships_usage_contexts(request: HttpRequest) -> HttpResponse:
    ...
    try:
        ...
        return _render_resource_view(
            request, "relationships_usage_contexts.html", context
        )
...
@require_super_admin
def media_manager_relationships_by_page(
    ...
    try:
        ...
        result = relationships_service.list_relationships(
            page_id=page_id, limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by page {page_id}: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_page_count(
    request: HttpRequest, page_id: str
) -> HttpResponse:
    ...
    try:
        ...
        logger.error(
            f"Error loading relationships by page count for {page_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_page_primary(
    request: HttpRequest, page_id: str
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            page_id=page_id, usage_type="primary", limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by page {page_id} primary: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_by_page.html",
...
@require_super_admin
def media_manager_relationships_by_page_secondary(
    request: HttpRequest, page_id: str
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            page_id=page_id, usage_type="secondary", limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by page {page_id} secondary: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
def media_manager_relationships_by_page_by_usage_type(
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            page_id=page_id, usage_type=usage_type, limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by page {page_id} and usage type {usage_type}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_endpoint(
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            endpoint_id=endpoint_id, limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by endpoint {endpoint_id}: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_endpoint_count(
    request: HttpRequest, endpoint_id: str
) -> HttpResponse:
    ...
    try:
        ...
        logger.error(
            f"Error loading relationships by endpoint count for {endpoint_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_endpoint_pages(
    request: HttpRequest, endpoint_id: str
) -> HttpResponse:
    ...
    try:
        ...
        return _render_resource_view(
            request, "relationships_by_endpoint_pages.html", context
        )

    except Exception as e:
        logger.error(
            f"Error loading relationships by endpoint pages for {endpoint_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
def media_manager_relationships_by_endpoint_by_usage_context(
    ...
    try:
        ...
        logger.error(
            f"Error loading relationships by endpoint {endpoint_id} and usage context {usage_context}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_type(
    request: HttpRequest, usage_type: str
) -> HttpResponse:
    """GET /docs/relationships/by-usage-type/<usage_type>/"""
    try:
        relationships_service = get_relationships_service()
        relationships = relationships_service.get_relationships_by_usage_type(
            usage_type
        )
        ...
        context: Dict[str, Any] = {
            ...
            else relationships.get("total", 0),
            "usage_type": usage_type,
            "filters": {"usage_type": usage_type},
        }

        return _render_resource_view(
            request, "relationships_by_usage_type.html", context
        )

    except Exception as e:
        logger.error(
            f"Error loading relationships by usage type {usage_type}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_type_primary(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_type="primary", limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by usage type primary: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_by_usage_type.html",
...
@require_super_admin
def media_manager_relationships_by_usage_type_secondary(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_type="secondary", limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by usage type secondary: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_by_usage_type.html",
...
@require_super_admin
def media_manager_relationships_by_usage_type_conditional(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_type="conditional", limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by usage type conditional: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_by_usage_type.html",
...
@require_super_admin
def media_manager_relationships_by_usage_type_count(
    request: HttpRequest, usage_type: str
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_type=usage_type, limit=None, offset=0
        )
        count = result.get("total", 0)
        ...
        logger.error(
            f"Error loading relationships by usage type count for {usage_type}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
def media_manager_relationships_by_usage_type_by_usage_context(
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_type=usage_type, usage_context=usage_context, limit=None, offset=0
        )
        ...
        logger.error(
            f"Error loading relationships by usage type {usage_type} and usage context {usage_context}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_context(
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_context=usage_context, limit=None, offset=0
        )
        ...
        return _render_resource_view(
            request, "relationships_by_usage_context.html", context
        )

    except Exception as e:
        logger.error(
            f"Error loading relationships by usage context {usage_context}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_context_data_fetching(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_context="data_fetching", limit=None, offset=0
        )
        context: Dict[str, Any] = {
            "relationships": result.get("relationships", []),
            "total": result.get("total", 0),
        ...
        logger.error(
            f"Error loading relationships by usage context data_fetching: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_context_data_mutation(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_context="data_mutation", limit=None, offset=0
        )
        context: Dict[str, Any] = {
            "relationships": result.get("relationships", []),
            "total": result.get("total", 0),
        ...
        logger.error(
            f"Error loading relationships by usage context data_mutation: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_context_authentication(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_context="authentication", limit=None, offset=0
        )
        context: Dict[str, Any] = {
            "relationships": result.get("relationships", []),
            "total": result.get("total", 0),
        ...
        logger.error(
            f"Error loading relationships by usage context authentication: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_context_analytics(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        relationships_service = get_relationships_service()
        result = relationships_service.list_relationships(
            usage_context="analytics", limit=None, offset=0
        )
        context: Dict[str, Any] = {
            "relationships": result.get("relationships", []),
            "total": result.get("total", 0),
        ...
        logger.error(
            f"Error loading relationships by usage context analytics: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_usage_context_count(
    request: HttpRequest, usage_context: str
) -> HttpResponse:
    ...
    try:
        ...
        logger.error(
            f"Error loading relationships by usage context count for {usage_context}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationships_count.html",
            {"usage_context": usage_context, "count": 0, "error": str(e)},
            error_message=str(e),
        )


@require_super_admin
def media_manager_relationships_by_state(
    ...
    try:
        ...
        rels = [
            x
            for x in (result.get("relationships") or [])
        ...
        logger.error(
            f"Error loading relationships by state {state}: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_by_state.html",
            {"relationships": [], "total": 0, "state": state, "error": str(e)},
            error_message=str(e),
        )


@require_super_admin
def media_manager_relationships_by_state_count(
    request: HttpRequest, state: str
) -> HttpResponse:
    ...
    try:
        ...
        logger.error(
            f"Error loading relationships by state count for {state}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
...
@require_super_admin
def media_manager_relationships_by_lambda(
    ...
    try:
        ...
        logger.error(
            f"Error loading relationships by lambda {service_name}: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_by_lambda.html",
            {
                "relationships": [],
                "total": 0,
                "service_name": service_name,
...
@require_super_admin
def media_manager_relationships_by_invocation_pattern(
    ...
    try:
        ...
        return _render_resource_view(
            request, "relationships_by_invocation_pattern.html", context
        )
    except Exception as e:
        logger.error(
            f"Error loading relationships by invocation pattern {pattern}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationships_by_invocation_pattern.html",
            {"relationships": [], "total": 0, "pattern": pattern, "error": str(e)},
            error_message=str(e),
        )


@require_super_admin
def media_manager_relationships_by_postman_config(
    ...
    try:
        ...
        context: Dict[str, Any] = {
            ...
            "total": len(rels),
            "config_id": config_id,
            "filters": {"postman_config_id": config_id},
        }
        return _render_resource_view(
            request, "relationships_by_postman_config.html", context
        )
    except Exception as e:
        logger.error(
            f"Error loading relationships by postman config {config_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationships_by_postman_config.html",
            {"relationships": [], "total": 0, "config_id": config_id, "error": str(e)},
            error_message=str(e),
        )
...
def media_manager_relationships_performance_slow(request: HttpRequest) -> HttpResponse:
    ...
    try:
        ...
        context: Dict[str, Any] = {
            "relationships": rels,
            "total": len(rels),
            "performance_type": "slow",
        }
        return _render_resource_view(request, "relationships_performance.html", context)
    except Exception as e:
        logger.error(
            f"Error loading slow performance relationships: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_performance.html",
            {
                "relationships": [],
                "total": 0,
                "performance_type": "slow",
...
@require_super_admin
def media_manager_relationships_performance_errors(
    request: HttpRequest,
) -> HttpResponse:
    ...
    try:
        ...
        context: Dict[str, Any] = {
            "relationships": rels,
            "total": len(rels),
            "performance_type": "errors",
        }
        return _render_resource_view(request, "relationships_performance.html", context)
    except Exception as e:
        logger.error(
            f"Error loading error performance relationships: {e}", exc_info=True
        )
        return _render_resource_view(
            request,
            "relationships_performance.html",
...
@require_super_admin
def media_manager_relationship_access_control(
    request: HttpRequest, relationship_id: str
) -> HttpResponse:
    ...
    try:
        ...
        context: Dict[str, Any] = {
            ...
            "access_control": relationship.get("access_control"),
        }
        return _render_resource_view(
            request, "relationship_access_control.html", context
        )
    except Http404:
        raise
    except Exception as e:
        logger.error(
            f"Error loading relationship access control for {relationship_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationship_access_control.html",
            {
                "relationship_id": relationship_id,
                "access_control": None,
                "error": str(e),
...
@require_super_admin
def media_manager_relationship_data_flow(
    request: HttpRequest, relationship_id: str
) -> HttpResponse:
    ...
    try:
        ...
        logger.error(
            f"Error loading relationship data flow for {relationship_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationship_data_flow.html",
            {"relationship_id": relationship_id, "data_flow": None, "error": str(e)},
            error_message=str(e),
        )


@require_super_admin
def media_manager_relationship_performance(
    request: HttpRequest, relationship_id: str
) -> HttpResponse:
    ...
    try:
        ...
        logger.error(
            f"Error loading relationship performance for {relationship_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationship_performance.html",
            {"relationship_id": relationship_id, "performance": None, "error": str(e)},
            error_message=str(e),
        )


@require_super_admin
def media_manager_relationship_dependencies(
    request: HttpRequest, relationship_id: str
) -> HttpResponse:
    ...
    try:
        ...
        context: Dict[str, Any] = {
            "relationship": relationship,
            "relationship_id": relationship_id,
            "dependencies": relationship.get("dependencies", []),
        }
        ...
        logger.error(
            f"Error loading relationship dependencies for {relationship_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationship_dependencies.html",
            {"relationship_id": relationship_id, "dependencies": [], "error": str(e)},
            error_message=str(e),
        )


@require_super_admin
def media_manager_relationship_postman(
    request: HttpRequest, relationship_id: str
) -> HttpResponse:
    ...
    try:
        ...
        context: Dict[str, Any] = {
            "relationship": relationship,
            "relationship_id": relationship_id,
            "postman": relationship.get("postman"),
        }
        ...
        logger.error(
            f"Error loading relationship postman for {relationship_id}: {e}",
            exc_info=True,
        )
        return _render_resource_view(
            request,
            "relationship_postman.html",
            {"relationship_id": relationship_id, "postman": None, "error": str(e)},
            error_message=str(e),
        )
