...
def get_pages_url(
    page_id: Optional[str] = None, sub_resource: Optional[str] = None, **query_params
) -> str:
    """
    ...
    **query_params,
    ...
    if endpoint_id and sub_resource:
        ...
        try:
            ...
            url = reverse(
                f"documentation:endpoint_{sub_resource_normalized}", args=[endpoint_id]
            )
        except NoReverseMatch:
            # Fallback to enhanced detail view
    ...
    **query_params,
    ...
    if relationship_id and sub_resource:
        ...
        try:
            # Use new unified route names
            url = reverse(
                f"documentation:relationship_{sub_resource_normalized}",
                args=[relationship_id],
            )
        except NoReverseMatch:
            # Fallback to enhanced detail view
            url = reverse(
                "documentation:relationship_detail_enhanced", args=[relationship_id]
            )
...
def get_postman_url(
    config_id: Optional[str] = None, sub_resource: Optional[str] = None, **query_params
) -> str:
    """
    ...
    if config_id and sub_resource:
        ...
        if sub_resource == "environment" and "env_name" in query_params:
            ...
            try:
                # Use new unified route names
                url = reverse(
                    "documentation:postman_environment", args=[config_id, env_name]
                )
            except NoReverseMatch:
            ...
            try:
                url = reverse(
                    "documentation:postman_mapping", args=[config_id, mapping_id]
                )
            except NoReverseMatch:
                url = reverse("documentation:postman_detail_enhanced", args=[config_id])
            ...
            try:
                url = reverse(
                    "documentation:postman_test_suite", args=[config_id, suite_id]
                )
            except NoReverseMatch:
                url = reverse("documentation:postman_detail_enhanced", args=[config_id])
        else:
            try:
                # Use new unified route names
                url = reverse(
                    f"documentation:postman_{sub_resource_normalized}", args=[config_id]
                )
            except NoReverseMatch:
                url = reverse("documentation:postman_detail_enhanced", args=[config_id])
    elif config_id:
