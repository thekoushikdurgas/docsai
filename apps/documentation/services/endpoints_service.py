...
class EndpointsService(DocumentationServiceBase):
    ...
    def get_endpoints_bulk(
        self, endpoint_ids: List[str], use_cache: bool = True
    ...
    def get_endpoint_by_path(
        ...
        return self.unified_storage.get_endpoint_by_path_and_method(
    ...
    def get_pages_using_endpoint(
        ...
        endpoint = self.unified_storage.get_endpoint_by_path_and_method(
            endpoint_path, method
        )
        if not endpoint:
            return []
    ...
    def create_endpoint(
        ...
        return self._create_resource(
            resource_data=endpoint_data, operation_name="create_endpoint"
        )
    ...
    def delete_endpoint(self, endpoint_id: str) -> bool:
        ...
        result = self._delete_resource(
            resource_id=endpoint_id, operation_name="delete_endpoint"
        )
        return result
    ...
    def _clear_cache_for_endpoint(self, endpoint_id: str) -> None:
        ...
        try:
            ...
            self.logger.warning(
                f"Failed to clear cache for endpoint {endpoint_id}: {e}"
            )

    def get_endpoints_by_api_version(
        self, api_version: str, method: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            result = self.unified_storage.list_endpoints(
                api_version=api_version, method=method
            )
    ...
    def get_endpoints_by_version_and_method(
        ...
        try:
            ...
            logger.warning(
                f"Repository failed for get_endpoints_by_version_and_method: {e}"
            )
    ...
    def get_endpoint_pages(self, endpoint_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not relationships_result or not relationships_result.get(
                "relationships"
            ):
                return {"pages": []}
    ...
    def get_endpoints_by_lambda_service(
        ...
        for endpoint in endpoints:
            ...
            if isinstance(lambda_services, list):
                if any(
                    ls.get("service_name") == service_name
    ...
    def get_endpoint_lambda_services(
