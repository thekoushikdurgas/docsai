...
from apps.documentation.repositories.unified_storage_base import BaseUnifiedStorage, StorageBackend
...
class PagesStorageMixin:
    ...
    def get_page(self, page_id: str, page_type: Optional[str] = None) -> Optional[Dict[str, Any]]:
        ...
        def _fetch_from_s3():
            ...
            if self.s3_circuit_breaker:
                return self.s3_circuit_breaker.call(repo.get_by_page_id, page_id, page_type)
    ...
    def get_type_statistics(self) -> Dict[str, Any]:
        ...
        statistics = [
            {"type": t, "count": v["total"], "published": v["published"], "draft": v["draft"], "deleted": v["deleted"]}
