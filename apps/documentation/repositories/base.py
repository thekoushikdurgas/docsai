...
class BaseRepository:
    ...
    def _ensure_id_field(
        self, resource_data: Dict[str, Any], resource_id: str
    ) -> Dict[str, Any]:
        """
    ...
    def get_by_id(self, resource_id: str, **filters) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            for resource in resources:
                ...
                for filter_key, filter_value in filters.items():
                    ...
                    if isinstance(resource_value, str) and isinstance(
                        filter_value, str
                    ):
