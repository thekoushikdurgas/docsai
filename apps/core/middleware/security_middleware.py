    ...
    def process_response(self, request, response):
        ...
        if not request.path.startswith('/admin/') and not settings.DEBUG:
            response['Content-Security-Policy'] = (
                ...
                "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://d3js.org https://cdn.jsdelivr.net https://contact360docs.s3.amazonaws.com; "
                "script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://d3js.org https://cdn.jsdelivr.net https://contact360docs.s3.amazonaws.com; "
