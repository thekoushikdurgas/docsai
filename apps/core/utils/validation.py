...
class DataValidator:
    ...
    def validate_string_length(
        data: Dict[str, Any], field_lengths: Dict[str, Tuple[int, Optional[int]]]
    ) -> Tuple[bool, Optional[Dict[str, List[str]]]]:
        """
    ...
    def validate_choices(
        data: Dict[str, Any], field_choices: Dict[str, List[Any]]
    ) -> Tuple[bool, Optional[Dict[str, List[str]]]]:
        """
    ...
    def validate_all(
        ...
        custom_validators: Optional[
            List[Callable[[Dict[str, Any]], Tuple[bool, Optional[str]]]]
        ] = None,
    ) -> Tuple[bool, Optional[Dict[str, List[str]]]]:
        """
    ...
    def validation_error_response(
        errors: Dict[str, List[str]], message: str = "Validation failed"
    ) -> JsonResponse:
        """
        ...
        """
        return JsonResponse(
            {"success": False, "error": message, "errors": errors}, status=400
        )
