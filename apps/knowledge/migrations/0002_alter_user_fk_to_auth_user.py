...
def null_user_fks(apps, schema_editor):
    ...
    with connection.cursor() as c:
        c.execute("UPDATE knowledge_base SET created_by_id = NULL")
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='knowledge_items', to='auth.user'),
        ),
    ]
