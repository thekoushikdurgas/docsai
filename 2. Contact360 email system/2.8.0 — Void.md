...
## Tasks
### Contract
- 📌 Planned: Freeze **event types** for `email.job.started`, `email.job.progress`, `email.job.completed`, `email.job.failed` — **Service task slices** below (includes former `logsapi-email-system-task-pack.md` scope).
