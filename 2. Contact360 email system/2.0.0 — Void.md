...
## Tasks
### Contract
- ✅ Completed: 📌 Planned: Freeze **GraphQL email** field names and error codes for finder + verifier single paths — **Service task slices** below (includes former `appointment360-email-system-task-pack.md` scope).
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: request: `{"email": "<string, valid email>"}`) | patch `2.0.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: document rate limit for email risk a…) | patch `2.0.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: freeze confidence score mapping and …) | patch `2.0.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- ✅ Completed: 📌 Planned: **s3storage** — freeze multipart API contract (initiate/parts/register/complete/abort) per `lambda/s3storage/docs/API.md`; lock retry-safe completion semantics.
...
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: write `hfservice.json_task()` prompt…) | patch `2.0.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: harden single verify path: syntax ->…) | patch `2.0.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- 📌 Planned: **[appointment360]** — refine duplicate task (was: ✅ completed: 📌 planned: replace **in-memory** multipart sess…) | patch `2.0.0` band `0` | reason: specialize this file vs sibling patches; see docs/codebases/appointment360-codebase-analysis.md
- ✅ Completed: ⬜ Incomplete: **s3storage** — enforce `X-Idempotency-Key` for initiate/complete/abort; persist idempotency state alongside multipart session JSON in S3.
- ✅ Completed: ⬜ Incomplete: **s3storage** — E2E failure-path tests: partial upload, worker timeout, duplicate complete (no double-charge storage or metadata).

### Data
- ✅ Completed: 📌 Planned: **s3storage** — metadata reconciliation command: compare S3 objects vs `metadata.json` entries, flag drift, schedule periodic runs.


### Surface

- ✅ Completed: 📌 Planned: **[emailapis]** — Verify UX for route `/` and bindings (patch 2.0.0 band 0) | area: `frontend-page` | files: `contact360/dashboard/app/page.tsx` | reason: Dashboard/extension surface for era 2 must match gateway contracts


### Ops

- ✅ Completed: 📌 Planned: **[platform]** — Record smoke evidence, rollback, and alerts (patch band 0: charter/P0) | area: `ops` | files: `docs/commands/`, `.github/workflows/` | reason: Smoke, rollback, and observability for patch 2.0.0
