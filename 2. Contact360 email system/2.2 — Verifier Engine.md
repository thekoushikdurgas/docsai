...
- 📌 Planned: Freeze **Mailvetter v1** validate response → GraphQL mapping table — **Service task slices** in `2.2.P` patch files (scope from former `mailvetter-email-system-task-pack.md`).  
...
- 📌 Planned: Baseline load: single-verify QPS.
