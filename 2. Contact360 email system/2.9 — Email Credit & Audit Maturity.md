...
- ✅ Completed: 📌 Planned: **Job create** accepts `credit_estimate` / `billing.correlation_id` pattern (align `jobs` pack).

### Service

- ✅ Completed: 📌 Planned: Block bulk start when **insufficient** credits (consistent with `1.x`).
- ✅ Completed: 📌 Planned: Idempotent credit charge on **retry** (no double charge).

### Surface

- ✅ Completed: 📌 Planned: App shows **estimated** bulk cost before submit.

### Data

- ✅ Completed: 📌 Planned: Reconciliation query: usage vs S3 row counts sample.
- ✅ Completed: 📌 Planned: PII tagging on buckets used for email CSV.

### Ops

- ✅ Completed: 📌 Planned: Weekly reconciliation report or notebook.
