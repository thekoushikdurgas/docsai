...
- ✅ Completed: 📌 Planned: Define **mailbox session** API (issue/refresh/revoke) — no long-lived password in browser.
- ✅ Completed: 📌 Planned: Document **IMAP** capability assumptions (TLS, OAuth later).

### Service

- ✅ Completed: 📌 Planned: Backend proxy or token exchange **before** removing `X-Password` (phased).
...
- ✅ Completed: 📌 Planned: Basic client retry/backoff for IMAP fetch.
