...
- ✅ Completed: 📌 Planned: Processors: `email_finder_export_stream.py`, `email_verify_export_stream.py` — **idempotent** resume.
...
- ✅ Completed: 📌 Planned: Clear copy for **partial failure** (some rows failed).

### Data

- ✅ Completed: 📌 Planned: **job_response** / checkpoint fields documented.
- ✅ Completed: 📌 Planned: Output S3 **prefix** and lifecycle.

### Ops

- ✅ Completed: 📌 Planned: Runbook: stuck job → safe retry.
