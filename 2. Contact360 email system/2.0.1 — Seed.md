...
## Tasks
### Contract
- 📌 Planned: Document **Lambda** invocation payload and provider selection order — **Service task slices** below (includes former `emailapis-email-system-task-pack.md` scope).
