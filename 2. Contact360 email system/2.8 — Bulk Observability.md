...
- ✅ Completed: 📌 Planned: Admin or internal Grafana **dashboards** linked from runbook.

### Data

- ✅ Completed: 📌 Planned: Retention and **PII** redaction rules for CSV payloads.
- ✅ Completed: 📌 Planned: Partition strategy for high volume.

### Ops

- ✅ Completed: 📌 Planned: On-call runbook: interpret metrics for stuck bulk job.
