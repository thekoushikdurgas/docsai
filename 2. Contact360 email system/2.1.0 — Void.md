...
## Tasks
### Contract
- 📌 Planned: Freeze **finder** GraphQL input/output and enum for pattern sources — **Service task slices** below (includes former `appointment360-email-system-task-pack.md` scope).
