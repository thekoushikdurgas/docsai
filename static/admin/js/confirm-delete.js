...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    var message = form.dataset.confirmDelete || 'Are you sure you want to delete this item? This action cannot be undone.';
    ...
    if (modal) {
      ...
      if (confirmForm) {
        ...
        Array.from(form.querySelectorAll('input[type="hidden"]')).forEach(function (inp) {
          var existing = confirmForm.querySelector('input[name="' + inp.name + '"]');
