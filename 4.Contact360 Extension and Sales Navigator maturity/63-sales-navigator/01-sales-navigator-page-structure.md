---
id: 4.4.0.1
title: Sales Navigator page structure & selectors (InMail credits, notes, tags)
phase: 4.Contact360 Extension and Sales Navigator maturity
owner: TBD
last_reviewed: 2026-04-19
status: stub
flow_refs: ["flow3", "flow5"]
schema_refs: ["Organization.json", "BillingLedgerEntry.json", "Activity.json"]
---

# Sales Navigator page structure & selectors (InMail credits, notes, tags)

> Stub generated from [`index.json`](../index.json) (`4.4.0.1`) on 2026-04-19.
