---
id: 4.4.2.1
title: Sales Navigator sequence automation (scheduled messages, reminders)
phase: 4.Contact360 Extension and Sales Navigator maturity
owner: TBD
last_reviewed: 2026-04-19
status: stub
flow_refs: ["flow4", "flow5"]
schema_refs: ["SequenceStep.json"]
---

# Sales Navigator sequence automation (scheduled messages, reminders)

> Stub generated from [`index.json`](../index.json) (`4.4.2.1`) on 2026-04-19.
