---
id: 4.4.1.2
title: Job change detection & alerts (new role, company change)
...
# Job change detection & alerts (new role, company change)

> Stub generated from [`index.json`](../index.json) (`4.4.1.2`) on 2026-04-19.
