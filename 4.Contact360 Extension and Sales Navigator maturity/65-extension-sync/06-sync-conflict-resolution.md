---
id: 4.6.1.3
title: Conflict resolution (user added contact on web, extension has local copy)
...
# Conflict resolution (user added contact on web, extension has local copy)

> Stub generated from [`index.json`](../index.json) (`4.6.1.3`) on 2026-04-19.
