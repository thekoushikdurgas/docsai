---
id: 4.6.0.3
title: Offline mode (graceful degradation, local queue)
...
# Offline mode (graceful degradation, local queue)

> Stub generated from [`index.json`](../index.json) (`4.6.0.3`) on 2026-04-19.
