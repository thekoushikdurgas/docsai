---
id: 4.6.0.1
title: Chrome storage APIs (local, sync, session; quota & limits)
...
# Chrome storage APIs (local, sync, session; quota & limits)

> Stub generated from [`index.json`](../index.json) (`4.6.0.1`) on 2026-04-19.
