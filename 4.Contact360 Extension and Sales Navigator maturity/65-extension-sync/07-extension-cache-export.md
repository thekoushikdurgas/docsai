---
id: 4.6.2.1
title: Export cache to file (for debugging, user request)
...
# Export cache to file (for debugging, user request)

> Stub generated from [`index.json`](../index.json) (`4.6.2.1`) on 2026-04-19.
