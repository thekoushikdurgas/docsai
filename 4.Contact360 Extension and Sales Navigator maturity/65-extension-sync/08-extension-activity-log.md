---
id: 4.6.2.2
title: Activity log in extension (all actions taken via popup)
...
# Activity log in extension (all actions taken via popup)

> Stub generated from [`index.json`](../index.json) (`4.6.2.2`) on 2026-04-19.
