---
id: 4.11.0.1
title: Unit tests for content scripts (DOM parsing, data extraction)
...
# Unit tests for content scripts (DOM parsing, data extraction)

> Stub generated from [`index.json`](../index.json) (`4.11.0.1`) on 2026-04-19.
