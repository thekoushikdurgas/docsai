---
id: 4.11.0.2
title: Integration tests (extension ↔ API, local storage, OAuth)
...
# Integration tests (extension ↔ API, local storage, OAuth)

> Stub generated from [`index.json`](../index.json) (`4.11.0.2`) on 2026-04-19.
