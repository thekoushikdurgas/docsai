---
id: 4.11.2.2
title: Release process (test → Chrome Web Store → auto-update)
...
# Release process (test → Chrome Web Store → auto-update)

> Stub generated from [`index.json`](../index.json) (`4.11.2.2`) on 2026-04-19.
