---
id: 4.11.1.3
title: "Regression testing (update doesn't break existing flows)"
...
# Regression testing (update doesn't break existing flows)

> Stub generated from [`index.json`](../index.json) (`4.11.1.3`) on 2026-04-19.
