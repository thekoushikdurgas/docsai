---
id: 4.11.2.3
title: Rollback strategy (if new version breaks, revert)
...
# Rollback strategy (if new version breaks, revert)

> Stub generated from [`index.json`](../index.json) (`4.11.2.3`) on 2026-04-19.
