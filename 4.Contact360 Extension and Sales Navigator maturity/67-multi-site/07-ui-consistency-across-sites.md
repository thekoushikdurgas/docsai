---
id: 4.8.2.1
title: UI consistency across sites (same popup design, same actions)
...
# UI consistency across sites (same popup design, same actions)

> Stub generated from [`index.json`](../index.json) (`4.8.2.1`) on 2026-04-19.
