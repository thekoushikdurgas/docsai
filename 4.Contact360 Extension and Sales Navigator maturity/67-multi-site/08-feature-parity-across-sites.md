---
id: 4.8.2.2
title: Feature parity (all sites get same enrichment, same logging)
...
# Feature parity (all sites get same enrichment, same logging)

> Stub generated from [`index.json`](../index.json) (`4.8.2.2`) on 2026-04-19.
