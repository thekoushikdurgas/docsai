---
id: 4.7.0.1
title: Extension event tracking (popup open, enrichment triggered, add to CRM)
...
# Extension event tracking (popup open, enrichment triggered, add to CRM)

> Stub generated from [`index.json`](../index.json) (`4.7.0.1`) on 2026-04-19.
