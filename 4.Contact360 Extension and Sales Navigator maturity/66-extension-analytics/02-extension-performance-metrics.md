---
id: 4.7.0.2
title: Performance metrics (enrichment latency, popup render time)
...
# Performance metrics (enrichment latency, popup render time)

> Stub generated from [`index.json`](../index.json) (`4.7.0.2`) on 2026-04-19.
