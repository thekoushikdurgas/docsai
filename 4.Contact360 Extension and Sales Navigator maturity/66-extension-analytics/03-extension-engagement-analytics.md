---
id: 4.7.0.3
title: User engagement analytics (active users, daily active usage)
...
# User engagement analytics (active users, daily active usage)

> Stub generated from [`index.json`](../index.json) (`4.7.0.3`) on 2026-04-19.
