---
id: 4.7.1.2
title: Debug mode (verbose logs, local storage inspection)
...
# Debug mode (verbose logs, local storage inspection)

> Stub generated from [`index.json`](../index.json) (`4.7.1.2`) on 2026-04-19.
