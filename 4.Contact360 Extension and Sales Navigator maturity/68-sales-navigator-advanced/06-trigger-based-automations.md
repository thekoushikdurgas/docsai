---
id: 4.9.1.3
title: Trigger-based automations (job change → send email, new hire → add to list)
phase: 4.Contact360 Extension and Sales Navigator maturity
owner: TBD
last_reviewed: 2026-04-19
status: stub
flow_refs: ["flow2", "flow3", "flow4", "flow5"]
schema_refs: []
---

# Trigger-based automations (job change → send email, new hire → add to list)

> Stub generated from [`index.json`](../index.json) (`4.9.1.3`) on 2026-04-19.
