---
id: 4.5.1.2
title: Email/phone enrichment results display (with confidence scores)
...
# Email/phone enrichment results display (with confidence scores)

> Stub generated from [`index.json`](../index.json) (`4.5.1.2`) on 2026-04-19.
