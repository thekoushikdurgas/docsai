---
id: 4.5.0.3
title: Quick actions (add to CRM, enrichment, send message)
phase: 4.Contact360 Extension and Sales Navigator maturity
owner: TBD
last_reviewed: 2026-04-19
status: stub
flow_refs: ["flow1", "flow2", "flow4"]
schema_refs: ["EnrichmentJob.json"]
---

# Quick actions (add to CRM, enrichment, send message)

> Stub generated from [`index.json`](../index.json) (`4.5.0.3`) on 2026-04-19.
