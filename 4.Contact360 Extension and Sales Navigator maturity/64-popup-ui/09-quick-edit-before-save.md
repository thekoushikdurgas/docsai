---
id: 4.5.2.3
title: Quick field editing in popup (name, title, company edit before save)
...
# Quick field editing in popup (name, title, company edit before save)

> Stub generated from [`index.json`](../index.json) (`4.5.2.3`) on 2026-04-19.
