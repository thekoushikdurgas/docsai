---
id: 4.5.3.2
title: Per-site controls (enable/disable on LinkedIn, Gmail, etc.)
...
# Per-site controls (enable/disable on LinkedIn, Gmail, etc.)

> Stub generated from [`index.json`](../index.json) (`4.5.3.2`) on 2026-04-19.
