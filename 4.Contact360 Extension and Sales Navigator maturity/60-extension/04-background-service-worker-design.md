---
id: 4.1.1.1
title: Background service worker (event listener, storage, OAuth token refresh)
...
# Background service worker (event listener, storage, OAuth token refresh)

> Stub generated from [`index.json`](../index.json) (`4.1.1.1`) on 2026-04-19.
