---
id: 4.1.0.2
title: Extension folder structure & build tooling (Vite, TypeScript, testing)
...
# Extension folder structure & build tooling (Vite, TypeScript, testing)

> Stub generated from [`index.json`](../index.json) (`4.1.0.2`) on 2026-04-19.
