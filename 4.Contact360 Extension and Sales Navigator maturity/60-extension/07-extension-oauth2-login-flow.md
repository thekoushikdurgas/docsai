---
id: 4.1.2.1
title: OAuth2 login flow (user authenticates with Contact360 via extension)
...
# OAuth2 login flow (user authenticates with Contact360 via extension)

> Stub generated from [`index.json`](../index.json) (`4.1.2.1`) on 2026-04-19.
