---
id: 4.1.2.2
title: Token management (refresh tokens, secure storage, expiry)
...
# Token management (refresh tokens, secure storage, expiry)

> Stub generated from [`index.json`](../index.json) (`4.1.2.2`) on 2026-04-19.
