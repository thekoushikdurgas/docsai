---
id: 4.1.0.1
title: MV3 manifest design (permissions, content scripts, background worker)
...
# MV3 manifest design (permissions, content scripts, background worker)

> Stub generated from [`index.json`](../index.json) (`4.1.0.1`) on 2026-04-19.
