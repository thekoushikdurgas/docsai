---
id: 4.12.0.1
title: Extension install/active user metrics (DAU, retention, churn)
...
# Extension install/active user metrics (DAU, retention, churn)

> Stub generated from [`index.json`](../index.json) (`4.12.0.1`) on 2026-04-19.
