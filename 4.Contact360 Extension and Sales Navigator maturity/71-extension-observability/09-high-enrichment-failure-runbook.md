---
id: 4.12.2.3
title: High enrichment failure rate (API issues, provider down)
...
# High enrichment failure rate (API issues, provider down)

> Stub generated from [`index.json`](../index.json) (`4.12.2.3`) on 2026-04-19.
