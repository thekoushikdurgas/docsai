---
id: 4.2.0.3
title: LinkedIn API alternative (Sales Navigator API vs scraping trade-offs)
...
# LinkedIn API alternative (Sales Navigator API vs scraping trade-offs)

> Stub generated from [`index.json`](../index.json) (`4.2.0.3`) on 2026-04-19.
