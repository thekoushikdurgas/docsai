---
id: 4.2.2.1
title: LinkedIn URL → email finding (use extracted name/company)
...
# LinkedIn URL → email finding (use extracted name/company)

> Stub generated from [`index.json`](../index.json) (`4.2.2.1`) on 2026-04-19.
