---
id: 4.2.1.1
title: Search results page scraping (detect & extract multiple profiles)
...
# Search results page scraping (detect & extract multiple profiles)

> Stub generated from [`index.json`](../index.json) (`4.2.1.1`) on 2026-04-19.
