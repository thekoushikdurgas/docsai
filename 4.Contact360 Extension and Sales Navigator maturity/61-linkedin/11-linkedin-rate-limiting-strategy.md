---
id: 4.2.3.2
title: Rate limiting strategy per user & org (requests/hour, backoff)
...
# Rate limiting strategy per user & org (requests/hour, backoff)

> Stub generated from [`index.json`](../index.json) (`4.2.3.2`) on 2026-04-19.
