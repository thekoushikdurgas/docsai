---
id: 4.10.1.2
title: Gmail API ToS compliance (what we can access, use, share)
...
# Gmail API ToS compliance (what we can access, use, share)

> Stub generated from [`index.json`](../index.json) (`4.10.1.2`) on 2026-04-19.
