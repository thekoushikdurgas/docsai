---
id: 4.10.0.2
title: Data minimization (scrape only what needed, delete after use)
...
# Data minimization (scrape only what needed, delete after use)

> Stub generated from [`index.json`](../index.json) (`4.10.0.2`) on 2026-04-19.
