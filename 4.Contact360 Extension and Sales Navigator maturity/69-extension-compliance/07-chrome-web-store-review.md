---
id: 4.10.2.1
title: "Chrome Web Store review process (what's required to publish)"
...
# Chrome Web Store review process (what's required to publish)

> Stub generated from [`index.json`](../index.json) (`4.10.2.1`) on 2026-04-19.
