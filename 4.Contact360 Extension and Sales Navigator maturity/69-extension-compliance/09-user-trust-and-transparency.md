---
id: 4.10.2.3
title: User trust & transparency (why request this permission, how is data used)
...
# User trust & transparency (why request this permission, how is data used)

> Stub generated from [`index.json`](../index.json) (`4.10.2.3`) on 2026-04-19.
