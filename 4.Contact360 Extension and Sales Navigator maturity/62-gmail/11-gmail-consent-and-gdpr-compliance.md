---
id: 4.3.3.2
title: GDPR consent for email logging (user disclosure, opt-in)
...
# GDPR consent for email logging (user disclosure, opt-in)

> Stub generated from [`index.json`](../index.json) (`4.3.3.2`) on 2026-04-19.
