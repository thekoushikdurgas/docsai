---
id: 4.3.0.3
title: Email metadata extraction (subject, from, to, date, message ID)
...
# Email metadata extraction (subject, from, to, date, message ID)

> Stub generated from [`index.json`](../index.json) (`4.3.0.3`) on 2026-04-19.
