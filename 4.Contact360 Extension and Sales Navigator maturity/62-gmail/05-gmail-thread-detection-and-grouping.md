---
id: 4.3.1.2
title: Email thread detection & grouping (same contact, same company)
...
# Email thread detection & grouping (same contact, same company)

> Stub generated from [`index.json`](../index.json) (`4.3.1.2`) on 2026-04-19.
