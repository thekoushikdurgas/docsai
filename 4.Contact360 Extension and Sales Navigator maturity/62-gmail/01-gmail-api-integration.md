---
id: 4.3.0.1
title: Gmail API integration (OAuth2, permission scopes, email read)
...
# Gmail API integration (OAuth2, permission scopes, email read)

> Stub generated from [`index.json`](../index.json) (`4.3.0.1`) on 2026-04-19.
