...
- **`contact360.extension`:** Chrome **MV3** (toolbar **popup** + **side panel**), vanilla JS + shared `ui/tokens.css` / `ui/components.css`; gateway **`EC2/extension.server`** (`/v1/save-profiles`, `/v1/scrape`); GraphQL JWT to **`api.contact360.io`** — see `contact360.extension/README.md`, `docs/frontend/pages/extension-index.json`
