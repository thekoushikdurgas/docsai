...
- ✅ Completed: ✅ Completed: **Health response JSON** schema documented per service family (FastAPI, Gin, Lambda) in `docs/ops/health-schema.md`.

### Service

- ✅ Completed: ✅ Completed: Each service: **startup config validation** — fail fast on missing env vars (`emailcampaign` pack pattern).

### Surface

- ✅ Completed: ✅ Completed: **app/admin/root:** production build passes; env injection documented.

### Data

- ✅ Completed: ✅ Completed: Backup/restore note for Postgres dev; ES optional; S3 bucket policy checklist.

### Ops

- ✅ Completed: ✅ Completed: **Runbook index** added at `docs/ops/runbooks/README.md`.
- ✅ Completed: ✅ Completed: **Deployment** branching strategy aligned with `docs/governance.md`.
