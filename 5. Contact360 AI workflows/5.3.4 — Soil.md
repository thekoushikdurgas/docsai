...
## Tasks
### Surface
- ✅ Completed: 📌 Planned: **app**: Credit/quota depleted states; upgrade CTAs; progress toward limits (design-system semantic colors).
...
### Data
- ✅ Completed: 📌 Planned: Usage ledger source of truth (table or cache) documented; tie to `user_id`.
