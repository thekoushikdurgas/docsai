...
## Tasks
### Surface
- ✅ Completed: 📌 Planned: **app**: Any “preview” of AI-bound payloads uses whitelist fields only.
...
### Data
- ✅ Completed: 📌 Planned: ES mappings support fields AI code depends on (e.g. quality scores).
