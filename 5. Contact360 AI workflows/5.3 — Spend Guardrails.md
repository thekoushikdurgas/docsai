...
- ✅ Completed: 📌 Planned: Define per-plan limits: messages/day, tokens/day, utility calls/day (`docs/governance.md`, [`ai-cost-governance.md`](ai-cost-governance.md)).
- ✅ Completed: 📌 Planned: Define provider budget: soft alert vs hard block semantics.

### Service

- ✅ Completed: 📌 Planned: **appointment360**: Enforce quota before `LambdaAIClient` calls; consistent error codes.
- ✅ Completed: 📌 Planned: **contact.ai**: `TokenBucketRateLimiter` tuned; optional env caps in `HFService` / Gemini clients per [`contact-ai-codebase-analysis.md`](../codebases/contact-ai-codebase-analysis.md).
...
- ✅ Completed: 📌 Planned: Dashboards: cost/token estimates, 429 rates, cap breaches.
