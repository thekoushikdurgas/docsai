...
- 📌 Planned: Internal troubleshooting views ([`logsapi-ui-bindings.md`](../frontend/logsapi-ui-bindings.md)); no customer PII in default admin grids.

### Data

- 📌 Planned: S3 CSV layout for AI events; retention vs general logs.
- 📌 Planned: Trace correlation: `request_id` / `trace_id` with Appointment360 and Contact AI.

### Ops

- 📌 Planned: Dashboards: cost spikes, error codes, provider latency.
- 📌 Planned: Runbook: log partition hot-spot mitigation.
