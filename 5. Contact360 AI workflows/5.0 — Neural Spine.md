...
- ✅ Completed: 📌 Planned: **app**: Document minimal AI chat data contracts (message JSON shape, sender enum) for future `/ai-chat` binding.
...
- ✅ Completed: 📌 Planned: **appointment360**: Wire internal client to Contact AI base URL and headers from config/secrets.

### Surface

- ✅ Completed: 📌 Planned: **app**: Optional dev-only or internal surface to prove chat list/load (full journey is 5.1).
- ✅ Completed: 📌 Planned: **admin/root**: No product AI surface required at 5.0; link service README only.
...
- ✅ Completed: 📌 Planned: **JSONB messages**: Document element schema (`sender`, `text`, optional `contacts[]`).

### Ops

- ✅ Completed: 📌 Planned: **contact.ai**: `/health`, `/health/db`, rate limiter middleware, metrics hooks documented.
- ✅ Completed: 📌 Planned: **Secrets**: `HF_API_KEY`, `GEMINI_API_KEY`, `DB_URL` rotation runbook.
