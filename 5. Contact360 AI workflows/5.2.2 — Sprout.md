...
### Service
- 📌 Planned: Ensure **Connectra query outputs** include whitelist fields and optional confidence for AI chat/assist pipelines.
- 📌 Planned: Complete all chat CRUD endpoints: `GET/POST /api/v1/ai-chats/`, `GET/PUT/DELETE /api/v1/ai-chats/{id}/`.
- 📌 Planned: Implement Gemini fallback: if HF inference fails after N retries, call Gemini API.
- 📌 Planned: Add AI-friendly summarized reason generator from `score_details`.
