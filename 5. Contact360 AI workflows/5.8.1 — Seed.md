...
## Tasks
### Contract
- 📌 Planned: Update [`logsapi_endpoint_era_matrix.json`](../backend/endpoints/logsapi_endpoint_era_matrix.json) if new write paths.
...
### Service
- 📌 Planned: Authz on query paths for internal roles only.
