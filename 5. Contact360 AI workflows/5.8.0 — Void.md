...
## Tasks
### Contract
- 📌 Planned: Freeze era `5.x` AI event types and field dictionary (no raw prompts in prod tier if policy forbids).
...
### Service
- 📌 Planned: Implement redaction/minimization before persist.
