...
## Tasks
### Contract
- 📌 Planned: **GraphQL**: Freeze queries/mutations and `ModelSelection` enum; resolve drift vs Contact AI HF IDs ([`ai-workflows.md`](ai-workflows.md)).
...
### Service
- 📌 Planned: **appointment360**: Implement resolvers using `LambdaAIClient.send_message` / stream variant as designed.
