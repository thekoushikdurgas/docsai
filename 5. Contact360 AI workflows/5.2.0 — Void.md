...
## Tasks
### Contract
- 📌 Planned: **GraphQL**: `Message.confidence`, `Message.explanation` nullable strings documented in `17_AI_CHATS_MODULE.md`.
...
### Service
- 📌 Planned: **contact.ai**: Populate confidence/explanation in persisted JSON when model layer supports it.
