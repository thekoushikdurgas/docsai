...
## Tasks
### Contract
- ✅ Completed: 📌 Planned: **contact.ai**: Freeze REST paths under `/api/v1/ai-chats/` and auth model per [`contact_ai_endpoint_era_matrix.json`](../backend/endpoints/contact_ai_endpoint_era_matrix.json).
...
### Service
- ✅ Completed: 📌 Planned: **contact.ai**: Ship chat CRUD + `POST .../message` (sync) with `HFService` model chain; enforce 100-message cap and JSONB validation baseline.
