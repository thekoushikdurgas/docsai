...
- ✅ Completed: 📌 Planned: Map to [`docsai-sync.md`](../docsai-sync.md) if AI policy constants are mirrored in DocsAI.
...
- ✅ Completed: 📌 Planned: **appointment360**: Pass through or stamp version on GraphQL mutations if required for audit export.
...
- ✅ Completed: 📌 Planned: Runbook: rollback prompt — deploy previous `PROMPT_VERSION`, drain inflight, verify samples.
- ✅ Completed: 📌 Planned: CI check: prompt change requires changelog + version bump per `governance.md`.
