...
- 📌 Planned: **app**: Loading/error/toast patterns per [`design-system.md`](../frontend/design-system.md).
- 📌 Planned: **Bindings**: [`contact-ai-ui-bindings.md`](../frontend/contact-ai-ui-bindings.md) complete for 5.1.
...
- 📌 Planned: Metrics: GraphQL error rate to Contact AI timeouts.
