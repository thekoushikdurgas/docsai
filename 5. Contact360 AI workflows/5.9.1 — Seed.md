...
## Tasks
### Contract
- 📌 Planned: Emailapis: max payload shapes for finder/verifier bulk; error codes for AI orchestration.
...
### Service
- 📌 Planned: **emailapis**: Optional thin HTTP utilities or documented GraphQL-only orchestration via Appointment360.
