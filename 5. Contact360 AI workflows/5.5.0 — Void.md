...
## Tasks
### Contract
- 📌 Planned: Minimum SN contact eligibility for AI: title, `data_quality_score` threshold, `about` presence (**Service task slices** below (includes former `salesnavigator-ai-workflows-task-pack.md` scope)).
...
### Service
- 📌 Planned: **salesnavigator**: Extraction preserves `about` length limits and encoding.
