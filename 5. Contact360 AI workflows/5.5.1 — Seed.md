...
## Tasks
### Contract
- 📌 Planned: JSONB `messages.contacts[]` includes `seniority`, `departments`, SN URL fields where available.
...
### Service
- 📌 Planned: **Connectra**: Index `data_quality_score` for VQL; validate filter operators.
