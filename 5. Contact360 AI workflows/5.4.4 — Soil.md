...
## Tasks
### Surface
- ✅ Completed: 📌 Planned: **admin**: Optional internal page listing active prompt version and history (per `admin-codebase-analysis.md`).
...
### Data
- ✅ Completed: 📌 Planned: Migration plan for new column(s) on `ai_chats` or audit sidecar.
