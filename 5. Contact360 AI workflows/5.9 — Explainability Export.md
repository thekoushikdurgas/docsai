...
- 📌 Planned: Verifier UI: explanation drawer on row click (**Service task slices** in `5.9.P` patch files (scope from former `mailvetter-ai-task-pack.md`)).
- 📌 Planned: **app**: Assistant panel shows canonical statuses ([`emailapis-ui-bindings.md`](../frontend/emailapis-ui-bindings.md)).

### Data

- 📌 Planned: Normalized reason codes and optional factor vectors per result.
- 📌 Planned: Retention for AI-derived summaries.
