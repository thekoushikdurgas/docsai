...
## Tasks
### Contract
- ✅ Completed: 📌 Planned: Publish **AI-facing field whitelist** (stable names and types) for contacts/companies.
...
### Service
- ✅ Completed: 📌 Planned: Ensure query outputs include confidence metadata when enrichment produces it.
