...
## Tasks
### Contract
- 📌 Planned: Mailvetter: frozen JSON schema for AI consumers; **no** raw SMTP payload in AI path.
...
### Service
- 📌 Planned: **mailvetter**: Summarize `score_details` into `top_factors` + `risk_reason` + `confidence_band`.
