...
## Tasks
### Contract
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: signed url policies for ai consumers…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: **tenant isolation:** assert every a…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: lock `sendmessageinput.model` contra…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: define prompt-safe output contract (…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md

### Service
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: ensure **connectra query outputs** i…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: complete all chat crud endpoints: `g…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: implement gemini fallback: if hf inf…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: add ai-friendly summarized reason ge…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
...
- 📌 Planned: **[contact-ai]** — refine duplicate task (was: ✅ completed: 📌 planned: **[contact-ai]** — update postgresql…) | patch `5.7.2` band `2` | reason: specialize this file vs sibling patches; see docs/codebases/contact-ai-codebase-analysis.md
