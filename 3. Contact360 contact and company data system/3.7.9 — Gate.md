...
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: define **drift** semantics (missing …) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: **release gate** artifact: idempoten…) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Service

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: **persistent queue** for connectra j…) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: reconciliation job **schedule** and …) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Surface

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: admin/internal ui for drift report (…) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Data

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: backfill playbook: reindex + verify …) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Ops

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: runbook: “es green, pg correct, ui w…) | patch `3.7.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
