...
- **Status:** ✅ Completed
## Focus
Security nits from analyses

## Flowchart

```mermaid
flowchart LR
    patchNode["3.10.7 — Hardening"] --> workNode["Security nits from analyses"]
...
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: **`docs/versions.md`** and [`docs/ro…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: all **3.x** task packs: unchecked it…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Service

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: connectra: sample **es vs pg** spot-…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: appointment360: remove or ticket **d…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Surface

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: dashboard: [`dashboard-search-ux.md`…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: admin/root: contact/company **story*…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Data

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: mailvetter / email lineage: orphan *…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: campaign service: schema drift items…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Ops

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: support runbook: **single** doc path…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: **`docs/docsai-sync.md`** updated if…) | patch `3.10.7` band `7` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
