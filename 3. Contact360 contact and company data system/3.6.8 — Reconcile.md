...
```mermaid
flowchart LR
    patchNode["3.6.8 — Reconcile"] --> workNode["Count report"]
...
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: lock **`mappers.py`** output vs conn…) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: document **`placeholder_value`** / l…) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Service

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: **chunk-level idempotency token** on…) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: 100-profile integration test → conne…) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Surface

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: chips/badges: seniority, department,…) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Data

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: same **profile url** → same uuid on …) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Ops

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: parity: all input uuids discoverable…) | patch `3.6.8` band `8` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
