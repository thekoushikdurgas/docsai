...
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: document extension → relay → connect…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: lock **completeness** policy: min sc…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Service

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: `lambdaclient`: adaptive timeout, ba…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: relay normalizes sn **linkedin url**…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Surface

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: extension user feedback: duplicate d…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Data

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: attach **`source`** / provenance fie…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: validate uuid stability for same `pr…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md

### Ops

- 📌 Planned: **[connectra]** — refine duplicate task (was: ✅ completed: 📌 planned: session: log `duplicate_count`, `chu…) | patch `3.8.9` band `9` | reason: specialize this file vs sibling patches; see docs/codebases/connectra-codebase-analysis.md
