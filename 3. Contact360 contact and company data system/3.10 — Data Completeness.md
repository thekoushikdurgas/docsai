...
- 📌 Planned: Mailvetter / email lineage: orphan **verifier ↔ contact** report (see **Service task slices** in `3.10.P` patch files (scope from former `mailvetter-contact-company-task-pack.md`)).  
