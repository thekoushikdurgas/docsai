---
title: "graphql/VerifySingleEmail"
source_json: mutation_verify_single_email_graphql.json
generator: json_to_markdown_endpoints.py
---

# graphql/VerifySingleEmail

## Overview

Verify a single email via GraphQL email query (legacy endpoint file naming uses mutation_*). Uses LambdaEmailClient and runtime provider routing (`truelist`/`mailvetter`/`icypeas` depending on runtime policy).

## Identity

| Field | Value |
| --- | --- |
| endpoint_id | mutation_verify_single_email_graphql |
| _id | mutation_verify_single_email_graphql-001 |
| endpoint_path | graphql/VerifySingleEmail |
| method | QUERY |
| api_version | graphql |
...
```graphql
query VerifySingleEmail($input: SingleEmailVerifierInput!) { email { verifySingleEmail(input: $input) { email status emailState emailSubState certainty } } }
```
...
| --- | --- | --- | --- | --- | --- | --- |
| /email | Email Page | emailService.verifySingleEmail | useEmailVerifierSingle | primary | data_query | 2026-03-24T00:00:00.000000+00:00 |
...
- **page_count:** 1
- **Source:** `mutation_verify_single_email_graphql.json`
...
*Generated from `mutation_verify_single_email_graphql.json`. Re-run `python json_to_markdown_endpoints.py`.*
