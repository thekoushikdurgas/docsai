---
title: "graphql/CreateEmailVerifyExport"
source_json: mutation_create_email_verify_export_graphql.json
generator: json_to_markdown_endpoints.py
---

# graphql/CreateEmailVerifyExport

## Overview

Create an email verify export scheduler job via GraphQL jobs module. Maps to TKD Job endpoint `POST /api/v1/jobs/email-verify` and processor `email_verify_export_stream`.

## Identity

| Field | Value |
| --- | --- |
| endpoint_id | mutation_create_email_verify_export_graphql |
| _id | mutation_create_email_verify_export_graphql-001 |
| endpoint_path | graphql/CreateEmailVerifyExport |
| method | MUTATION |
| api_version | graphql |
...
```graphql
mutation CreateEmailVerifyExport($input: CreateEmailVerifyExportInput!) { jobs { createEmailVerifyExport(input: $input) { jobId status createdAt } } }
```
...
| --- | --- | --- | --- | --- | --- | --- |
| /email | Email Page | jobsService | useEmailVerifierBulk | primary | data_mutation | 2026-03-24T00:00:00.000000+00:00 |


### frontend_page_bindings

- contact360.io/app/app/(dashboard)/email/page.tsx
- contact360.io/app/src/hooks/useEmailVerifierBulk.ts
- contact360.io/app/src/services/graphql/jobsService.ts

## Inventory

- **page_count:** 1
- **Source:** `mutation_create_email_verify_export_graphql.json`
...
*Generated from `mutation_create_email_verify_export_graphql.json`. Re-run `python json_to_markdown_endpoints.py`.*
