---
title: "graphql/ListTeamMembers"
source_json: query_list_team_members_graphql.json
generator: json_to_markdown_endpoints.py
---

# graphql/ListTeamMembers

## Overview

List all team members for the current user's team. Returns team member profiles with roles and permissions.

## Identity

| Field | Value |
| --- | --- |
| endpoint_id | query_list_team_members_graphql |
| _id | query_list_team_members_graphql-001 |
| endpoint_path | graphql/ListTeamMembers |
| method | QUERY |
| api_version | graphql |
...
| Field | Value |
| --- | --- |
| service_file | appointment360/app/graphql/modules/profile/queries.py |
...
- **page_count:** 1
- **Source:** `query_list_team_members_graphql.json`
...
*Generated from `query_list_team_members_graphql.json`. Re-run `python json_to_markdown_endpoints.py`.*
