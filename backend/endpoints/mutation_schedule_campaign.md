---
title: "graphql/scheduleCampaign"
source_json: mutation_schedule_campaign.json
generator: json_to_markdown_endpoints.py
---

# graphql/scheduleCampaign

## Overview

scheduleCampaign operation for backend docs expansion.

## Identity

| Field | Value |
| --- | --- |
| endpoint_id | mutation_schedule_campaign |
| _id | mutation_schedule_campaign-001 |
| endpoint_path | graphql/scheduleCampaign |
| method | MUTATION |
| api_version | graphql |
...
- **page_count:** 1
- **Source:** `mutation_schedule_campaign.json`
...
- **Email APIs**: Schedule execution via `lambda/emailapis` or `lambda/emailapigo`.

## Related endpoint graph

- **Inbound**: `Campaigns Page`.
- **Outbound**: `CreateCampaign`, `PauseCampaign`.

<!-- AUTO:db-graph:end -->
---

*Generated from `mutation_schedule_campaign.json`. Re-run `python json_to_markdown_endpoints.py`.*
