---
title: "graphql/DeleteDashboardPage"
source_json: mutation_delete_dashboard_page_graphql.json
generator: json_to_markdown_endpoints.py
---

# graphql/DeleteDashboardPage

## Overview

Delete a custom dashboard page by pageId. Accepts DeleteDashboardPageInput with pageId (required, String). Permanently removes the page. Returns Boolean indicating success (true if deleted). Raises NotFoundError (404) if page not found. Raises ForbiddenError (403) if not Admin.

## Identity

| Field | Value |
| --- | --- |
| endpoint_id | mutation_delete_dashboard_page_graphql |
| _id | mutation_delete_dashboard_page_graphql-001 |
| endpoint_path | graphql/DeleteDashboardPage |
| method | MUTATION |
| api_version | graphql |
...
```graphql
mutation DeleteDashboardPage($input: DeleteDashboardPageInput!) { dashboardPages { deleteDashboardPage(input: $input) } }
```
...
- **page_count:** 1
- **Source:** `mutation_delete_dashboard_page_graphql.json`
...
*Generated from `mutation_delete_dashboard_page_graphql.json`. Re-run `python json_to_markdown_endpoints.py`.*
