---
title: "graphql/AddEmailPattern"
source_json: mutation_add_email_pattern_graphql.json
generator: json_to_markdown_endpoints.py
---

# graphql/AddEmailPattern

## Overview

Add a single email pattern for a company. Delegates to Lambda Email runtime pattern endpoint.

## Identity

| Field | Value |
| --- | --- |
| endpoint_id | mutation_add_email_pattern_graphql |
| _id | mutation_add_email_pattern_graphql-001 |
| endpoint_path | graphql/AddEmailPattern |
| method | MUTATION |
| api_version | graphql |
...
```graphql
mutation AddEmailPattern($input: AddEmailPatternInput!) { email { addEmailPattern(input: $input) { uuid companyUuid patternFormat patternString domain } } }
```
...
| --- | --- | --- | --- | --- | --- | --- |
| /email | Email Page | emailService.addEmailPattern |  | secondary | data_mutation | 2026-03-24T00:00:00.000000+00:00 |
...
- **page_count:** 1
- **Source:** `mutation_add_email_pattern_graphql.json`
...
*Generated from `mutation_add_email_pattern_graphql.json`. Re-run `python json_to_markdown_endpoints.py`.*
