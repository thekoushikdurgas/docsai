...
- The requests in this folder use `/api/v1/dashboard/...` (legacy base path). For the docs app, use `/docs/api/...` and the paths in `contact360.io/admin/docs/api.md`.

See `contact360.io/admin/docs/api.md` and `routes.md` for current endpoints and routes.
