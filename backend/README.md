...
| --- | --- | --- |
| [admin-codebase-analysis.md](../codebases/admin-codebase-analysis.md) | `contact360.io/admin` (DocsAI) | `apis/13_ADMIN_MODULE.md`, `appointment360_data_lineage.md`, `services.apis/admin.api.md`, gateway integration notes in `docs/docs/frontend.md` |
