-- AI chat conversations (Contact AI / contact.ai microservice)
-- Populated by backend(dev)/contact.ai; called by appointment360 with X-User-ID.
-- Messages are stored as JSON (SQLAlchemy `JSON` → PostgreSQL JSONB in typical deployments).
