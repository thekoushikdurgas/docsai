---
id: 0.6.1.3
title: "Example: AI agent tests (tool‑calling + safety)"
...
# Example: AI agent tests (tool‑calling + safety)

> Stub generated from [`index.json`](../index.json) (`0.6.1.3`) on 2026-04-19.
