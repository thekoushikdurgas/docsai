---
id: 0.2.3.4
title: `packages/ui` (design system & components)
...
No standalone **`packages/ui`** at repo root; dashboard components live under **contact360.io/app**. Future extraction possible.

Authoritative map: [`02-architecture/04-as-built-map.md`](../02-architecture/04-as-built-map.md) (`0.2.3.4`).
