---
id: 0.7.2.2
title: Initial runbooks (DB down, Kafka issues, AI quota exceeded)
...
# Initial runbooks (DB down, Kafka issues, AI quota exceeded)

> Stub generated from [`index.json`](../index.json) (`0.7.2.2`) on 2026-04-19.
