---
id: 0.2.2.5
title: `services/phone-service` skeleton
...
# `services/phone-service` skeleton

## Summary

**[EC2/phone.server](../../../EC2/phone.server)** — see [`backend/endpoints/phone.server/`](../../backend/endpoints/phone.server/).

Authoritative map: [`02-architecture/04-as-built-map.md`](../02-architecture/04-as-built-map.md) (`0.2.2.5`).
...
- Related flows:
- [flow2](../flows/FLOW-2-email-enrichment.md): `FLOW-2-email-enrichment.md`
- Related schemas:
- *(none)*
