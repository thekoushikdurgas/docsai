---
id: 0.2.2.3
title: `services/crm-service` skeleton
...
# `services/crm-service` skeleton

## Summary

CRM/contact **Connectra** satellite: **[EC2/sync.server](../../../EC2/sync.server)**. Docs: [`backend/endpoints/sync.server/`](../../backend/endpoints/sync.server/).

Authoritative map: [`02-architecture/04-as-built-map.md`](../02-architecture/04-as-built-map.md) (`0.2.2.3`).
