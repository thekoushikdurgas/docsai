---
id: 0.2.2.10
title: `services/file-service` skeleton
...
# `services/file-service` skeleton

## Summary

Object storage / uploads: **[EC2/s3storage.server](../../../EC2/s3storage.server)**; operational logs stream: **[EC2/log.server](../../../EC2/log.server)**.

Authoritative map: [`02-architecture/04-as-built-map.md`](../02-architecture/04-as-built-map.md) (`0.2.2.10`).
