---
id: 0.2.1.2
title: `apps/admin` scaffold (admin console)
...
# `apps/admin` scaffold (admin console)

## Summary

Django admin console: **[contact360.io/admin](../../../contact360.io/admin)**.

Authoritative map: [`02-architecture/04-as-built-map.md`](../02-architecture/04-as-built-map.md) (`0.2.1.2`).
