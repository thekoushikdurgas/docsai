---
id: 0.2.1.3
title: `apps/mcp-ui` scaffold (agent console / chat UI)
...
# `apps/mcp-ui` scaffold (agent console / chat UI)

> Stub generated from [`index.json`](../index.json) (`0.2.1.3`) on 2026-04-19.
