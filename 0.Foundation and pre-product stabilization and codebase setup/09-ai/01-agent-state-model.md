---
id: 0.5.0.1
title: Agent state model (context/intents/plan/results)
...
# Agent state model (context/intents/plan/results)

> Stub generated from [`index.json`](../index.json) (`0.5.0.1`) on 2026-04-19.
