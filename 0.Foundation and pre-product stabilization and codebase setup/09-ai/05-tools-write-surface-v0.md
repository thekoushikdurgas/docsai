---
id: 0.5.1.2
title: Write tools spec (campaign.create, campaign.send, update_contact, etc.)
...
# Write tools spec (campaign.create, campaign.send, update_contact, etc.)

> Stub generated from [`index.json`](../index.json) (`0.5.1.2`) on 2026-04-19.
