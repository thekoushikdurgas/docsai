---
id: 0.6.0.1
title: Local stack (docker-compose for Postgres/Redis/OpenSearch/etc.)
...
# Local stack (docker-compose for Postgres/Redis/OpenSearch/etc.)

> Stub generated from [`index.json`](../index.json) (`0.6.0.1`) on 2026-04-19.
