---
id: 7.18.0.1
title: Change log & audit trail (who deployed what, when, why)
...
# Change log & audit trail (who deployed what, when, why)

> Stub generated from [`index.json`](../index.json) (`7.18.0.1`) on 2026-04-19.
