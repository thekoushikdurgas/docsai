---
id: 7.6.1.2
title: Consumer group setup (group ID, initial offset)
...
# Consumer group setup (group ID, initial offset)

> Stub generated from [`index.json`](../index.json) (`7.6.1.2`) on 2026-04-19.
