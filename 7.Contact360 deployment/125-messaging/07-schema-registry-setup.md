---
id: 7.6.2.1
title: Schema Registry setup (Confluent or custom)
...
# Schema Registry setup (Confluent or custom)

> Stub generated from [`index.json`](../index.json) (`7.6.2.1`) on 2026-04-19.
